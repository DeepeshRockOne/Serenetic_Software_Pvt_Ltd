...
class ExternalConfiguration
{
    ...
    function __construct($params = array())
    {
        ...
        $this->merchantID = (isset($params['merchantID'])?$params['merchantID']:'testrest');
        $this->apiKeyID = (isset($params['apiKeyID'])?$params['apiKeyID']:'08c94330-f618-42a3-b09d-e1e43be5efda');
        $this->secretKey = (isset($params['secretKey'])?$params['secretKey']:'yBJxy6LjM2TmcPGu+GaJrHtkke25fPpUX+UY6/L/1tE=');
        ...
        $this->runEnv = (isset($params['runEnv'])?$params['runEnv']:"apitest.cybersource.com");

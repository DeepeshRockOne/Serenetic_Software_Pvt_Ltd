         ...
         <div class="col-sm-12 col-md-6">
            <div class="form-group height_auto">
               <div class="input-group resources_addon">
                  ...
                  <div class="pr">
                     <select class="form-control select has-value" name="<?=$field['field_name']?>" data-live-search="true">
               ...
               <div class="col-sm-12 col-md-6">
                  <div class="form-group height_auto">
                     <div class="input-group resources_addon">
                        ...
                        <div class="pr">
                           <select class="form-control select has-value" name="custom_question_<?=$que['id']?>" data-live-search="true">
                              <option data-hidden="true"></option>
                                 <?php  
                                 $selected = false;

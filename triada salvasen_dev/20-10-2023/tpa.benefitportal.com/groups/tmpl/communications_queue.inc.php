            ...
            <div class="panel panel-default">
                <div class="panel-body p-b-0">
                  <div class="clearfix tbl_filter">
                    ...
                    <iframe onload="$('#ajex_loader').show();" id="br_queue_iframe" src="<?= $GROUP_HOST; ?>/draft_broadcast_group.php?<?= $_SERVER['QUERY_STRING'] ?>" frameborder="0" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" width="100%" scrolling="no"></iframe>
                </div>
            </div>
            <div class="panel panel-default">
              <div class="panel-body p-b-0">
                <iframe onload="$('#ajex_loader').show();" id="br_history_iframe" src="<?= $GROUP_HOST; ?>/all_broadcast_group.php?<?= $_SERVER['QUERY_STRING'] ?>" frameborder="0" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" width="100%" scrolling="no"></iframe>
              </div>
            </div>
        </div>
    <div class="clearfix"></div>

...
<div class="theme-form">
   <form action="" name="primary_policy_form" id="primary_policy_form">
      <?php /*<input type="hidden" name="has_full_access" id="has_full_access" value="<?=$has_full_access == false?0:1?>"> */ ?>
      ...
      <div class="row">
         ...
         <div class="col-sm-6">
            <div class="form-group">
               <input type="text" name="email" value="<?=$row['email']?>" class="form-control no_space" <?php //$has_full_access == false?"readonly":""?>>
               <label>Email</label>
         ...
         <div class="col-sm-6">
            <div class="form-group">
               <input type="text" name="cell_phone" id="cell_phone" value="<?=format_telephone($row['cell_phone'])?>" class="form-control" <?php //$has_full_access == false?"readonly":"" ?>>
               <label>Phone</label>
         ...
         <div class="col-sm-6">
            <div class="form-group">
               <input type="text" name="address" id="address" value="<?=$row['address']?>" class="form-control" <?php //$has_full_access == false?"readonly":""?>>
         ...
         <div class="col-sm-4">
            <div class="form-group">
               <input type="text" name="city" value="<?=$row['city']?>" id="city" class="form-control" <?php //$has_full_access == false?"readonly":""?>>
               <label>City</label>
         ...
         <div class="col-sm-4">
            <div class="form-group">
               ...
               <p class="error error_zip" id="error_zip"></p>
               <input type="hidden" name="old_zip" value="<?=$row['zip']?>">
            </div>
         </div>
         <div class="col-sm-4">
            <div class="form-group">
               <input type="text" name="birth_date" id="birth_date" value="<?=getCustomDate($row['birth_date'])?>" class="form-control" <?php //$has_full_access == false?"readonly":""?>>
               <label>DOB</label>
         ...
         <div class="col-sm-4">
            <div class="phone-control-wrap">
               ...
               <div class="phone-addon w-30"  <?php //$has_full_access == false?"style='display:none;'":""?>>
                  <div class="m-b-25">
         ...
         <div class="col-sm-4">
            <div class="form-group">
               ...
               <input type="password" id="password" name="password" value="" class="form-control"  maxlength="20" 
                              ...
                              onkeyup="check_password_Keyup(this, 'password_err','error_password', event, 'input_validation');" <?php //$has_full_access == false?"readonly":""?>>
               <?php /* } else { ?>

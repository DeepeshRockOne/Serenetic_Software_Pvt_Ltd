    ...
    if ($total_rows > 0) {
      foreach ($fetch_rows as $rows) {?>
        <tr>
              ...
              <td class="icons">
                <a href="members_details.php?id=<?php echo $rows['id']; ?>" target="_blank" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-eye"></i></a>

                <?php /*<a href="member_enrollment.php?customer_id=<?php echo $rows['id']; ?>" target="_blank" data-toggle="tooltip" data-placement="top" title="Add Products"><i class="fa fa-plus"></i></a>*/ ?>
              </td>
            </tr>
      <?php } ?>
    <tfoot>

                        ...
                        <table cellpadding="0" cellspacing="0" width="100%">
                           <tbody>
                              <tr>
                                 ...
                                 <td style="padding: 15px; background-color: #FAFBFB;">Make amendment(s) to your invoice by clicking the checkboxes next to the product categories you believe should be omitted from the balance of this statement.</td>
                              </tr>
                           </tbody>
                        </table>
                        <div style="padding: 30px;">
                           ...
                           <div class="theme-form">
                              <div class="form-group">
                                 <select class="se_multiple_select list-bill-select" name="rep_id[]" id="rep_id"
                                         multiple="multiple">
...
<script type="text/javascript">
   ...
   $(document).on("click","#btn_confirm",function(){
      $("#ajax_loader").show();
      $.ajax({
         url:'<?= $GROUP_HOST ?>/ajax_add_amendment_listbill.php',
         dataType:'JSON',

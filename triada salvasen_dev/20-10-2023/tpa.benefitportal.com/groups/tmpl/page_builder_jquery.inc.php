<script type="text/javascript">
    ...
    $(function () {
        ...
        $(document).on('click','.btn_cancel',function(){
            swal({
                text: "Cancel Canges: Are you sure?",
                showCancelButton: true,
                confirmButtonText: "Confirm"
            }).then(function(){
        ...
        trigger("#page_builder", function ($this, e) {
            ...
            $("#header_subcontent").val(CKEDITOR.instances.header_subcontent.getData());
            e.preventDefault();
    ...
    trigger(".pb_img_delete", function ($this) {
        ...
        trashQuestion(function () {
            handler("<?=$GROUP_HOST?>/ajax_page_edit_image.php", "action=delete&page_builder_id=<?=$page_builder_id?>&image_id=" + $image_id, function () {
                $("#ajax_loader").show();
            }, function (data) {
                $("#ajax_loader").hide();
                if (data.status == "success") {
    ...
    $(document).ready(function () {
        ...
        initCKEditor("header_subcontent",false,'360px');
    });
    /*img slider start*/

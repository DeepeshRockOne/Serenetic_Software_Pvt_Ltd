            ...
            <tbody>
                <?php if ($total_rows > 0) { ?>
                    ...
                    <tr>
                        ...
                        <td class="icons">
                            <a href="javascript:void(0)" data-toggle="tooltip" data-placement="top" title="Duplicate" onclick="redirect_page('page_builder.php?id=<?=$rows['id'];?>&is_clone=Y')"><i class="fa fa-clone" aria-hidden="true" ></i></a>
                            <a href="<?=$HOST?>/group_prd_preview.php?page_builder_id=<?=$rows['id'];?>" target="_blank"><i class="fa fa-eye"></i></a>
                            <a href="page_builder.php?id=<?=$rows['id'];?>"><i class="fa fa-edit"></i></a>
                            <?php if($rows['status'] == "Draft" || $rows['status'] == "Inactive" || $rows['status'] == "") { ?>

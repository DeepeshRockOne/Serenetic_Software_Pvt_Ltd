         ...
         <div class="panel-heading clearfix br-b">
            ...
            <div class="pull-right">
              ...
              <?php if($resListBill['status']=='open'){ ?>
                ...
                <a href="<?=$HOST?>/pay_bill.php?location=group&list_bill_id=<?=$list_bill_id?>" class="btn btn-action pay_bill">+ Pay Now</a>
                <?php } ?>
              ...
              <a href="group_billing.php" class="btn red-link">Back</a>
            </div>
         </div>
                  ...
                  <form id="list_bill_notes_form" name="list_bill_notes_form" action="">
                    ...
                    <div class="theme-form m-t-30">
                       <div class="form-group height_auto">
                          <textarea class="form-control bill-form-control" id="notes" name="notes" rows="4" placeholder="Notes…" disabled=""><?= $notes ?></textarea>
                       </div>
                    </div>
                  </form>
...
<script type="text/javascript">
   ...
   function autoResize(i) {
    ...
    $(document).on("click","#add_notes",function(){
      $("#ajax_loader").show();
      $.ajax({
         url:'<?= $GROUP_HOST ?>/ajax_list_bill_notes.php',
         dataType:'JSON',

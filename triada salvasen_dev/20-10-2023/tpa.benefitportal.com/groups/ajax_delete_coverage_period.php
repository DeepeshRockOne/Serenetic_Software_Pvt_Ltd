...
if (!empty($srow)) {
  ...
  $update_sub_where = array(
    'clause' => 'group_coverage_period_id = :id',
    'params' => array(
      ':id' => makeSafe($srow['id'])
    )
  );
  $pdo->update("group_coverage_period_offering", $update_params, $update_sub_where);
  ...
  $description['ac_message'] =array(
    ...
    'ac_message_1' =>' deleted Plan Period ',
    'ac_red_2'=>array(
  ...
  activity_feed(3,$_SESSION['groups']['id'], 'Group' , $srow['id'], 'group_coverage_period', 'Group Deleted Plan Period',$_SESSION['groups']['fname']." ".$_SESSION['groups']['lname'],"",$desc, "", "");
  $res['status'] = 'success';
  $res['msg'] = 'Plan Deleted Successfully';

...
// Read transactions activity code start
  ...
  activity_feed(3, $_SESSION['groups']['id'], 'Group',$transId, 'transactions','Viewed Transactions', $_SESSION['groups']['fname'],$_SESSION['groups']['lname'],json_encode($description));
...
$detSql = "SELECT pm.type,pm.product_type,od.product_name,od.start_coverage_period,od.end_coverage_period,ppt.title as planTitle,od.unit_price as price,od.is_refund
        ...
        JOIN order_details od ON(t.order_id=od.order_id AND od.product_id=st.product_id)

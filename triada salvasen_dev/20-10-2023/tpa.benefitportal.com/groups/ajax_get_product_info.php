                                ...
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <?php if (check_is_card_exist($data['p_id'])) { ?>
                                        <tr>
                                            <td>ID Card:</td>
                                            <td class="icons">
                                                <a href="<?= $HOST ?>/id_card_popup.php?ws_id=<?= md5($data['ws_id']) ?>&user_type=Group&user_id=<?=$_SESSION['groups']['id']?>"
                                        ...
                                        <td class="icons">
                                            ...
                                            <?php if ($policy_change_op == true && $tier_change_op == true) { ?>
                                                <?php if (!in_array($data['plan_status'], array("Inactive", "Cancel")) && !($data['new_plan_id'] > 0 && $data['process_status'] == "Pending") && empty($data['termination_date'])) { ?>
                                                    <a href="<?=$HOST?>/effective_billing_date.php?location=group&ws_id=<?= md5($data['ws_id']) ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if($termination_date_op == true){ ?>
                                                ...
                                                <a href="<?=$HOST?>/add_term_date.php?location=group&ws_id=<?= md5($data['ws_id']) ?>"
                                                   class="add_term_date text-action m-l-10 fw500"
                                                   style="<?= (empty($data['termination_date']) && $is_requested_date) ? '' : 'display: none;' ?>">+ Term</a>
                                                ...
                                                if ($allow_cancel_termination == true && !in_array($data['product_type'],array('Healthy Step','ServiceFee')) && $data['process_status'] != "Pending" && strtotime($data['termination_date']) > 0 && in_array($data['customer_status'], array('Active', 'Inactive')) && $allow_to_reinstate) {
                                                    ...
                                                    if (in_array($data['reinstate_option'], array('Available Without Restrictions')) || $is_reinstate_option_within == true) { ?>
                                                        <a href="<?=$HOST?>/reinstate_products.php?location=group&customer_id=<?= $data['c_id'] ?>&ws_id=<?= $data['ws_id'] ?>"
                            ...
                            <?php if ($dependents) {
                                foreach ($dependents as $key => $value) { ?>
                                    <tr class="depedents_tr_<?= $value['id'] ?>">
                                        ...
                                        <td class="icons">
                                            <a href="<?=$HOST?>/prd_detail_edit_depedents.php?location=group&id=<?= $value['id'] ?>"
                                    ...
                                    <div class="row table-footer-row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="pull-right">
                                                <a href="<?=$HOST?>/assign_depedents.php?location=group&ws_id=<?= md5($data['ws_id']) ?>"
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td class="icons">
                                                ...
                                                <a href="<?=$HOST?>/active_member_since.php?location=group&ws_id=<?= md5($data['ws_id']) ?>"
                                                   data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Edit"
                                                   class="billing_date_popup m-l-10"><i class="fa fa-edit fa-lg"
                                                                                        aria-hidden="true"></i></a>
                                                <?php } ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($curr_policy_benefit_amount > 0) { ?>
                                                <td>
                                                    ...
                                                    <a href="<?=$HOST?>/benefit_tier_change.php?location=group&action=benefit_amount_change&ws_id=<?=$data['ws_id']?>"
                                                       data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Edit"
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="icons">
                                        ...
                                        <a href="<?=$HOST?>/edit_next_billing_date.php?location=group&ws_id=<?= md5($data['ws_id']) ?>"
                                           data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Edit"
                                           class="billing_date_popup m-l-10"><i class="fa fa-edit fa-lg"
                                                                                aria-hidden="true"></i></a>
                                        <?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if(!empty($res) && $res["failCoverage"] == 'Y'){ ?>
                                            Missing an Approved Payment <span class="icons"><a href="<?=$HOST?>/payment_failed_coverages_details.php?websiteId=<?=md5($data['ws_id'])?>&customerId=<?=md5($data['c_id'])?>" data-toggle="tooltip" data-trigger="hover" data-original-title="Plan Details" class="coverage_popup"><i class="fa fa-exclamation-circle fa-lg"></i></a></span>
                                        <?php }else{ ?>

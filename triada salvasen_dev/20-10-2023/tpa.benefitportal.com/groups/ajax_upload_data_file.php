...
if ($validate->isValid()) {
    ...
    $MEMBER_IMPORT_ARR = array(
        'ENROLLING AGENT/GROUP' => array(
            array(
                'label' => 'Group ID',
                'file_label' => 'ENROLLING_GROUP_ID',
                'info' => 'Unique identifier of group this member falls underneath',
                'field_name' => 'enrolling_group_id',
                'is_required' => 'Y'
            ),
        ),
        'MEMBER'=> array(
            ...
            */
            ...
            array(
                ...
                'info' => 'Indicator of group enrollee type (Existing, New, Renew)',
                'field_name' => 'enrollee',
                'is_required' => 'Y'
            ),
            array(

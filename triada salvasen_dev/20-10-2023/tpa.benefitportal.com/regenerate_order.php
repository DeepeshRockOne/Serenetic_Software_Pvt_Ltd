...
if($get_payent_method){
    ...
    $billSql = "SELECT *, 
        ...
        FROM customer_billing_profile WHERE is_direct_deposit_account='N' AND md5(customer_id)=:customer_id and is_deleted='N'";
...
if($get_coverage_period && !empty($product_id)){
    ...
    $member_payment_type = isset($_POST['member_payment_type'])?$_POST['member_payment_type']:array();
    $start_coverage_date = isset($_POST['start_date'])?$_POST['start_date']:'';

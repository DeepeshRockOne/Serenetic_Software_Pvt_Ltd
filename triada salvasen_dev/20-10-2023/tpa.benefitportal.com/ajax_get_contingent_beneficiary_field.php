...
$contingent_beneficiary_number = isset($_POST['contingent_beneficiary_field_number'])? explode("_", $_POST['contingent_beneficiary_field_number']):array();

$number = $contingent_beneficiary_number[0];
$display_number = $contingent_beneficiary_number[1];

$response['number']=$number;

$contingent_existing_dependent = !empty($_POST['contingent_existing_dependent']) ? $_POST['contingent_existing_dependent'] : array();
...
$child_fname = !empty($_POST['child_fname']) ? $_POST['child_fname'] : '';

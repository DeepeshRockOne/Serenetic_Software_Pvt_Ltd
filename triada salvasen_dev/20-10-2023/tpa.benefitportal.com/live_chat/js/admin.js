...
(function ($) {
    ...
    */
    ...
    function dialog(text, type, onConfirm, has_custom_message) {
        let box = $(admin).find('.sb-dialog-box').attr('data-type', type);
        if(typeof(has_custom_message) !== "undefined" && has_custom_message == true) {
            $(box).find('p').html(sb_(text));
        } else {

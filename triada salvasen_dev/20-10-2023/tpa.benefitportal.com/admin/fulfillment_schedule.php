...
if(!empty($file_id)){
	$sql_file = "SELECT * FROM fulfillment_files WHERE id=:file_id"; 
	...
	$eligiblity_sql = "SELECT *,AES_DECRYPT(password,'$CREDIT_CARD_ENC_KEY') as file_password FROM fulfillment_schedule WHERE is_deleted='N' AND file_id=:id";
...
$template = "fulfillment_schedule.inc.php";

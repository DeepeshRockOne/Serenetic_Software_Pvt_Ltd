      ...
      <div class="row theme-form">
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="hidden" name="old_bill_address" id="old_bill_address" value="<?= !empty($bill_address) ? $bill_address : '' ?>">
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="hidden" name="old_bill_zip" id="old_bill_zip" value="<?= !empty($bill_zip) ? $bill_zip : '' ?>">
          </div>
        </div>
      </div>
    </div>

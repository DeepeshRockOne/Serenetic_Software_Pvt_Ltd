...
$options = array(
	...
	'url' => 'email_broadcaster_history_page.php?' . $query_string,
	'db_handle' => $pdo->dbh,
...
if ($is_history_ajaxed) {
	try {
		...
		$sel_sql = "SELECT b.id, b.brodcast_name, b.status, b.display_id, b.created_at, CONCAT(a.fname, ' ',a.lname) as admin_name, a.display_id as admin_display_id, a.id as admin_id, b.total_users, b.total_sent
				...
				WHERE b.sender_type='Admin' AND b.type='email' AND b.status IN ('Completed','Cancelled') AND b.is_deleted = 'N' " . $incr . "
	...
	include_once 'tmpl/email_broadcaster_history_page.inc.php';
	exit;
}
...
$template = 'email_broadcaster_history_page.inc.php';

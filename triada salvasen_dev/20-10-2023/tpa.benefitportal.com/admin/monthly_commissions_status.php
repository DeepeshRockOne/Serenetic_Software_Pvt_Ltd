...
$breadcrumbes[3]['title'] = 'Monthly Commission Period ('.date("m/d/Y",strtotime($_GET['pay_period'])).')';
}else{
...
if (isset($_GET["is_ajax"])) {
    include 'tmpl/monthly_commissions_status.inc.php';
    exit;
}
...
$template = 'monthly_commissions_status.inc.php';

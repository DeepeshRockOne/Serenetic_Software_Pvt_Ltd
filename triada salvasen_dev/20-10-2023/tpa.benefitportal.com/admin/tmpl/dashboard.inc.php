...
<div class="dashboard_topbar clearfix pr">
    <div class="row">
        <div class="col-sm-12 dashboard_topbar_right top_header_section">
            <div class="dash_top_counter">
                <p class="fs14 text-uppecase mn text-light-gray">WELCOME</p>
                <p class="fs18  mn text-action fw500"><?= $_SESSION['admin']['fname'] . ' ' . $_SESSION['admin']['lname'] ?></p>
            </div>
            <div class="dash_top_counter">
            ...
            <div class="dash_top_counter">
                <a href="javascript:void(0);" class="btn btn-info" id="btn_select_date"><?=date('m/d/Y')?></a>
            </div>
        </div>
    </div>
    <div class="dashboard-data-wrap custom-data-wrap theme-form" id="custom-date-toggle" style="display: none;">
                ...
                <div class="dash_netsales_box gross_net_sales_section">
                    <div class="text-center">
                        <p class="fw500">
                            ...
                            <i class="fa fa-info-circle fa-lg gross_net_sales_tooltip" data-placement="bottom" rel="tooltip" data-toggle="tooltip"></i>
                        </p>
                        <p class="fw600 fs26">
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%">
                            ...
                            <tr class="gross_net_sales_more_tr_1" style="display:none">
                                <td>Avg Plan/Member</td>
                                <td class="avg_policy_per_member">0</td>
                            </tr>
                            <tr class="gross_net_sales_more_tr_2" style="display:none">
                                <td>Policies</td>
                                <td class="new_policies">0</td>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <div class="col-md-6 ">
                <div class="dash_top_performing">
                    <div class="row">
                            ...
                            <div class="theme-form max-w175">
                                <div class="form-group">
                                    <select name="agencies_or_agents" id="agencies_or_agents" class="form-control">
                                        ...
                                        <option value="Agencies" selected>Agencies</option>
                        ...
                        <div class="col-sm-8 text-right m-t-7">
                            <label class="radio-inline" style="font-weight: bold;">Sort by :</label>
                            <label class="radio-inline"><input type="radio" name="top_agents_short_by" value="Members">Members</label>
                            <!-- <label class="radio-inline"><input type="radio" name="top_agents_short_by" value="Policies">Policies</label> -->
                            <label class="radio-inline"><input type="radio" name="top_agents_short_by" value="Sales" checked="">Sales</label>
                        </div>
                    </div>
                    <div class=" table-responsive panel-body-scroll m-t-10" style="max-height:180px;">
        ...
        <div class="panel panel-default dashboard-panel dashboard-state-panel">
            <div class="panel-heading clearfix panel-selection fs14">
                <div class="row">
                    ...
                    <div class="col-md-8 m-t-7 text-right dashboard-radio-responsive">
                        <label class="radio-inline" style="font-weight: bold;">Sort by :</label>
                ...
                <div class="dash_renewal_box">
                    ...
                    <div class="phone-control-wrap">
                        ...
                        <div class="phone-addon w-55">
                            <img src="<?=$HOST?>/images/icons/stopwatch.svg<?= $cache ?>" width="28px" height="33px">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-3">
                <div class="dash_renewal_box">
                    ...
                    <div class="phone-control-wrap">
                        ...
                        <div class="phone-addon w-55">
                            <img src="<?=$HOST?>/images/icons/folder.svg<?= $cache ?>" width="28px" height="33px">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-3">
                <div class="dash_renewal_box">
                    ...
                    <div class="phone-control-wrap">
                        ...
                        <div class="phone-addon w-55">
                            <img src="<?=$HOST?>/images/icons/projector.svg<?= $cache ?>" width="40px" height="18px">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-3">
                <div class="dash_renewal_box">
                    ...
                    <div class="phone-control-wrap">
                        ...
                        <div class="phone-addon w-55">
                            <img src="<?=$HOST?>/images/icons/monthly-projector.svg<?= $cache ?>" width="42px" height="33px">
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.btn_set_date', function(e) {
            ...
            $(".gross_net_sales_more_tr_2").hide();
    ...
    function load_all_section_data(load_top_header)
    {
    ...
    {   
        ajax_cnt++;
        $.ajax({
            url: "<?=$HOST?>/load_dashboard_report_data.php?portal=admin&report="+report,
            method: "POST",
            beforeSend: function () {          
                $("#ajax_loader").show();
            },
            ...
            success: function (res) {
                ...
                if(typeof(res.gross_net_sales_more) !== "undefined") {
                    ...
                    $(".gross_net_sales_more_tr_2").show();
                }

...
<div class="panel panel-default panel-block panel-title-block global_activity">
   <form id="frm_search_groups" action="global_activity_group_tabs.php" method="GET">
         ...
         <div class="panel-wrapper collapse in">
            <div class="panel-body theme-form">
                                         ...
                                         <div class="phone-control-wrap">
                                            ...
                                            <div class="phone-addon">
                                               <div class="input-group"> <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                  <input  type="text" class="form-control date_picker" name="date_from" id="date
                                                       _from" placeholder="MM / DD / YYYY">
                                               </div>
                                            </div>
                                            <div class="phone-addon">
                                            ...
                                            <div class="phone-addon">
                                               <div class="input-group"> <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                  <input  type="text" class="form-control date_picker" id="to_date" name="to_dat
                                                       e" placeholder="MM / DD / YYYY">
                                               </div>
                                            </div>
                                         </div>
                                      </div>
               ...
               <div class="panel-footer clearfix">
                  <button type="button" class="btn btn-info" name="search" id="btn_ajax_submit_groups"> <i class="fa fa-search"></i> Search </button>
                  <?php
                     // echo "<!-- <a href="javascript:void(0);" class="btn btn-info global_download" data-type="Agent"><i class="fa fa-download"></i> Export Search Results</a> -->"; ?>
...
<script type="text/javascript">
    $(document).ready(function(){
      initSelectizeDropDown('activity_by','globalActivityGroup',<?php echo $_BOOTSTRAP_TAGS_MIN_LENGTH; ?>);
      initSelectizeDropDown('impacted_name','globalActivityGroup',<?php echo $_BOOTSTRAP_TAGS_MIN_LENGTH; ?>);
      initSelectizeDropDown('ip_address','IPaddressGroup',<?php echo $_BOOTSTRAP_TAGS_MIN_LENGTH; ?>);
      //ajax_submit_groups();    
       $(document).off("click","#btn_ajax_submit_groups");
     $(document).on("click","#btn_ajax_submit_groups",function(){
  ...
  function ajax_submit_groups() {
      ...
      params += '&'+all_usersFrm;
      $.ajax({
          url: $('#frm_search_groups').attr('action'),
          type: 'GET',
          data: params,

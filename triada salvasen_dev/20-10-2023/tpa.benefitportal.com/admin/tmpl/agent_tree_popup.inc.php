    ...
    <div class="panel panel-default panel-block">
        ...
        <div class="panel-body text-right">
              <div class="spacetree_action">
                  ...
                  <a href="agent_tree_popup.php?agent_id=<?=$_GET['agent_id']?>&is_group=<?=$is_group?>" target="_blank" class="btn sp_link"><i class="fa fa-external-link" aria-hidden="true"></i></a>
              </div>
        </div>
...
<script language="javascript">
        ...
        st = new $jit.ST({
            ...
            request: function (nodeId, level, onComplete) {
              console.log(document.getElementById(nodeId));
                ...
                var is_group = document.getElementById('is_group').value;
                if (className_id) {
                    jQuery.get('ajax_sponsor_tree.php', {userId: className_id,is_group:is_group}, function (data) {
                        try {
                            if (data.length > 1) {
                                var json2 = eval("(" + data + ")");
    ...
    $(document).ready(function () {
        ...
        $('#refresh').click(function () {
            window.location="agent_tree_popup.php?agent_id=<?=$_GET['agent_id']?>&is_group=<?=$is_group?>";
        });

...
<div id="open_account_search">
  <form action="ajax_activity_feed_agent.php?id=<?php echo $_REQUEST['id']; ?>&for=agent" method="POST" id="acc_feed_search_form" class="theme-form">
...
<script type="text/javascript">
  ...
  $(document).on('click','#export_activity',function(e){
    ...
    confirm_export_data(function() {
        ...
        $.ajax({
          url: 'ajax_activity_feed_agent.php',
          type: 'POST',
  ...
  function ajax_load_activity_feed() {
    ...
    $.ajax({
      url: "ajax_activity_feed_agent.php",
      data: {id: '<?= $_REQUEST['id'] ?>',user_type:'Agent',activity_type:activity_type,keyword_search:keyword_search,acc_his_custom_date:acc_his_custom_date,acc_his_fromdate:acc_his_fromdate,acc_his_todate:acc_his_todate,for:'Agent'},
      type: 'POST',
      success: function(res) {
        $('#ajax_loader').hide();
  ...
  function ajax_reload_activity_feed() {
    ...
    $.ajax({
      url: "ajax_activity_feed_agent.php",
      data: {id: '<?= $_REQUEST['id'] ?>',user_type:'Agent',for:'Agent'},
      type: 'POST',
      success: function(res) {
        $('#ajax_loader').hide();
        $("#sec_acct_his").html(res);

                ...
                <tr>
                    ...
                    <div class="row theme-form">
                        <form action="agent_per_group_production_report.php" id="frm_search_group">
                            ...
                            <input type="hidden" name="groups_id" value="<?=$groups_id?>" id="groups_id">
                        </form>
                    </div>
                    </td>
                </tr>
                ...
                <form action="agent_per_group_production_report.php" id="frm_search_group">
                    ...
                    <div id="dt_range_group" class="col-sm-6" style="<?=!empty($join_range) ? '' : 'display:none' ?>">
                        <div class=" phone-control-wrap form-group height_auto m-b-5">
                            <div class="phone-addon" id="from_date_group">
                    ...
                    <div class="col-sm-2">
                        <button type="button" class="btn btn-action btn-block" id="search_group">Search</button>
                    </div>
                    <!-- </div> -->
                </form>
            </div>
...
$(document).on("change",'#join_range_group',function(){
    ...
    if($(this).val() == 'range') {
        $('#dt_range_group').css({ display: 'block' });
        $(".to_date").show();

<div class="panel panel-default theme-form">
   ...
   <div class="text-center ">
      <a href="listbill_pay_now.php" class="btn btn-action listbill_pay_now">Next</a>
...
$(document).off('click', '.listbill_pay_now');
  $(document).on('click', '.listbill_pay_now', function (e) {
    e.preventDefault();

            ...
            foreach ($fetch_rows as $rows) { ?>
              <tr>
                ...
                <td class="icons text-center">
                  <a href="fulfillment_export_requests.php?is_download=Y&file_name=<?=urlencode($rows['processed_file']);?>" data-toggle="tooltip" data-trigger="hover" title="Download"><i class="fa fa-download"></i></a>
                </td>
              </tr>  
            <?php } ?>
          <?php }else{ ?>
...
<?php }else{ ?>
  <?php include_once 'notify.inc.php';?>
    <form id="frm_search" action="fulfillment_processed_file.php" method="GET" class="sform">
       ...
       <div class="clearfix">
          <h4 class="pull-left m-t-7 m-b-0"><?=$file_name?> - <span class="fw300">Fulfillment Files</span></h4>

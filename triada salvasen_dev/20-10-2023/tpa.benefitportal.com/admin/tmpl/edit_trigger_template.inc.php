...
<div class="edit_trigger_template"> 
  <div class="">
    ...
    <div class="panel panel-default">
              <div class="panel-body">
                <form method="post" class="form-horizontal" name="template_frm" id="template_frm">
                  <div class="form-group">
                    <label class="col-lg-1 control-label" for="title">Title<em>*</em></label>
                    <div class="col-lg-3">
                    ...
                    <div class="col-md-12 text-center m-t-20">
                      ...
                      <button type="button" name="save" id="save" value="save" class="btn btn-info">Save</button>
                  ...
                  <div id="defaultContentDiv" style="<?= $type=='default' ? '' : 'display: none'; ?>">
                    <div class="col-md-6 col-lg-4">
                      <div id="demo-accordion" class="panel-group panel-collapsetab">
                        <div class="panel panel-default">
                          <div class="panel-heading">
                            ...
                            <div class="panel-body img_scroll"> 
                              <?php if (!empty($imgArray)) { ?>
                                <?php foreach ($imgArray as $key => $value) { 
                                    $TRIGGER_IMAGE_DIR = $SITE_SETTINGS[$value['company_id']]['TRIGGER_IMAGE']['upload'];
                                    $TRIGGER_IMAGE_WEB = $SITE_SETTINGS[$value['company_id']]['TRIGGER_IMAGE']['download'];
                                    ?>
                                  <div class="trigger_logo <?php echo isset($trg_img_check[$value['id']]) ? 'active' : ''; ?>" data-entity-id="<?= $value['id']; ?>" id="trigger_logo_<?= $value['id']; ?>">
                                    <img src="<?php echo remote_file_exists($TRIGGER_IMAGE_DIR . $value['src'],$value['company_id'])?$TRIGGER_IMAGE_WEB ."/". $value['src']:"-"; ?>" id="trg_img_<?= $value['id']; ?>" >
                    ...
                    <div class="table-responsive">
                        <table width="700" class="table table-bordered" cellspacing="0" cellpadding="20" border="0" align="center" style="border-top: 1px solid #cccccc;  border-left: 1px solid #cccccc;  border-right: 1px solid #cccccc;  border-bottom: 1px solid #cccccc;">
                          <tr>
                                  ...
                                  <td width="65%" style="font-size: 12px;  line-height: 1.4em; border: none; " id="trg_img_id_disp">
                                    <?php if (!empty($trg_img_check)) { ?>
                                      <?php foreach ($trg_img_check as $val) { 
                                              ...
                                              $t_img_res = $pdo->selectOne($t_img_sql,array(':id'=>$val));
                                              $TRIGGER_IMAGE_DIR = $SITE_SETTINGS[$t_img_res['company_id']]['TRIGGER_IMAGE']['upload'];
                                              $TRIGGER_IMAGE_WEB = $SITE_SETTINGS[$t_img_res['company_id']]['TRIGGER_IMAGE']['download'];
                                          ?>

  ...
  <div class="panel panel-default panel-block">
    <div class="panel-heading">
      <div class="panel-title">
        <p class="fs18"><strong class="fw500"><?=ucfirst($file_name);?> - </strong> <span class="fw300">(<?=$total_rows?>) Products</span></p>
      </div>
    </div>
...
<?php }else{ ?>
  <form id="frm_search" action="eligibility_product.php" method="GET">

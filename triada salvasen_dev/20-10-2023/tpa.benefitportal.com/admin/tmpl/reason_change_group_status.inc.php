<div class="panel panel-default">
   <form action="ajax_change_group_status.php" method="post" name="user_form" id="user_form" class="theme-form">
        ...
        <input type="hidden" name="status" value="<?php echo $_GET['status']; ?>">
          ...
          <div class="text-center">
            ...
            <?php if($from=='detail_page') {
              ...
              ?>
            <?php }else{
              $link = "parent.refreshGroupStatus("."'".$_GET["id"]."','".$_GET["old_status"]."')";
            } ?>
        ...
        if(data.status=='success'){
            parent.setNotifySuccess(data.msg);
             setTimeout(function(){
               ...
               <?php }else{ ?>
                parent.refreshGroupStatus("<?=$_GET["id"]?>","<?=$_GET['status']?>");
               <?php } ?>
             }, 1000);

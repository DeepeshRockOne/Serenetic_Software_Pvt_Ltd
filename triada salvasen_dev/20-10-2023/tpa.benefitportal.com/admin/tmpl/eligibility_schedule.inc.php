	...
	<form name="frmSchedule" id="frmSchedule" action="" method="POST">
		...
		<div class="panel-body theme-form">
            ...
            <label class='btn btn-info <?=$file_type == "schedule_change_file" ? "active":""?>'>
            	<input type="radio" class="file_type js-switch" name="file_type" value="schedule_change_file" <?=$file_type == 'schedule_change_file' ? 'checked=checked' : ''?>> Add/Change/Delete File
          	</label>
...
function eligibility_schedule(btn_obj) {
    ...
    $.ajax({
        url: '<?= $HOST ?>/admin/ajax_eligiblity_schedule.php',

...
<div class="panel panel-default panel-block panel-title-block global_activity">
   <form id="frm_search_agents" action="global_activity_agent_tabs.php" method="GET">
         ...
         <div class="panel-wrapper collapse in">
            <div class="panel-body theme-form">
               ...
               <div class="panel-footer clearfix">
                  <button type="button" class="btn btn-info" name="search" id="btn_ajax_submit_agents"> <i class="fa fa-search"></i> Search </button>
                  <?php
                  ...
                  <input type="hidden" name="is_ajaxed_agents" id="is_ajaxed_agents" value="1" />
...
<script type="text/javascript">
    $(document).ready(function(){
      initSelectizeDropDown('activity_by','globalActivityAgent',<?php echo $_BOOTSTRAP_TAGS_MIN_LENGTH; ?>);
      initSelectizeDropDown('impacted_name','globalActivityAgent',<?php echo $_BOOTSTRAP_TAGS_MIN_LENGTH; ?>);
      initSelectizeDropDown('ip_address','IPaddressAgent',<?php echo $_BOOTSTRAP_TAGS_MIN_LENGTH; ?>);
      //ajax_submit_agents();
      $(document).off("click","#btn_ajax_submit_agents");
      $(document).on("click","#btn_ajax_submit_agents",function(){
  ...
  function ajax_submit_agents() {
      $('#ajax_loader').show();
      $('#ajax_data').hide();
      $('#is_ajaxed_agents').val('1');

      var params = $('#frm_search_agents').serialize();
      var all_usersFrm = $('#all_usersFrm').serialize();
      params += '&'+all_usersFrm;
      $.ajax({
          url: $('#frm_search_agents').attr('action'),
          type: 'GET',
          data: params,

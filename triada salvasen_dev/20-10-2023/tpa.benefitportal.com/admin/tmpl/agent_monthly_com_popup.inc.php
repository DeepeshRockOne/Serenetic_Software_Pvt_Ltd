...
.table>tbody>tr>td.hiddenrow > .inner_row{border-top:1px solid #e6e6e6;}
</style>
<?php 
...
<div class="panel panel-default panel-block">
   <div class="panel-heading">
    ...
    <div class="thumbnail mn radius-zero br-n p-b-0">
      <div class="row">
         <div class="col-md-4">
            <p class="fs16 fw500">Monthly Commission Summary</p>
            <table class="m-b-30 weekly_com_sum">
               <tbody>
                  <tr>
                    <td width="100px"><?=$agentRow['name']?></td>
                    <td><strong>Period:</strong> <?=$startPayPeriod?> - <?=$endPayPeriod?></td>
                  </tr>
                  <tr>
                    <td width="100px"><a href="javascript:void(0);" class="red-link"><?=$agentRow['rep_id']?></a></td>
                    <td><strong>Total Commissions:</strong>&nbsp; <?=dispCommAmt($resMonthlyCommission['commTotal'])?>
                  </tr>
                </tbody>
            </table>
         </div>
     ...
     <div class="p-15 text-right bg_white br-b">
         <a class="btn btn-info">Debit Balance</a>
   ...
   <div class="theme-form">
      ...
      <div class="row">
        ...
        <div class="form-group height_auto">
            ...
            <a href="agent_monthly_com_popup.php?pay_period=<?=$pay_period?>&agent_id=<?=$agent_id?>&status=<?=$status?>" class="btn btn-info btn-outline">Clear Search</a>
       </div>
      </form>
   </div>
      <div class="table-responsive com_panel_tabel">
         <table class="table" style="table-layout: fixed;">
            <tbody>
               ...
               ?>
               <tr>
                  <td width="50px" data-toggle="collapse" data-target="#row_<?=$i?>" class="accordion-toggle text-center">
               ...
               <tr>
                  ...
                  <td class='text-right' colspan='3'><strong><?=dispCommAmt($totaladjustCommission,'text-blue')?></strong></td>
               </tr>

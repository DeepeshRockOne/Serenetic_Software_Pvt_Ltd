<div class="panel panel-default panel-block">
  <div class="panel-heading">
    <div class="panel-title">
      <p class="fs18"><strong class="fw500">Commission Per Level For - </strong> <span class="fw300">
        <?= $res_sql['name'] ?></span>
      </p>
    </div>
  </div>
  <div class="panel-body">
    <div id="enrollment_orders_his_con" class="table-responsive text-center">
      <table class="<?= $table_class ?>">
        <thead>
          <?php if ($res_sql['commission_on'] == 'Plan') { ?>
        ...
        <tbody>
          <?php if ($res_sql['commission_on'] == 'Agent Level') { ?>
            <tr>

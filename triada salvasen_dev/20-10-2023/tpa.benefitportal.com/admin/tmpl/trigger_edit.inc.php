  ...
  <div class="panel panel-default panel-popup">
    ...
    <div class="panel-body" >
      <div class="form-group">
        ...
        <div class="col-md-4">  
          <select id="category" name="category" class="form-control select2 <?php echo isset($errors['category']) ? 'parsley-error' : '' ?>">
      ...
      <div id="after_category" style="<?php
      ...
      ?>">
        ...
        <div class="form-group <?php echo isset($errors['description']) ? 'error' : '' ?>">
          ...
          <div class="col-md-4">            
            <textarea id="description" name="description" rows="2" class="form-control <?php echo isset($errors['description']) ? 'parsley-error' : '' ?>"><?= $description ?></textarea>            
        ...
        <div class="form-group <?php echo isset($errors['type']) ? 'error' : '' ?>">
          <label for="type" class="col-md-2">This communication will send</label>
          <div class="col-md-4">
            <select id="type" name="type" class="form-control select2 <?php echo isset($errors['type']) ? 'parsley-error' : '' ?>">
              <option  value=""></option>
        ...
        <div class="smstp tp <?php echo isset($errors['sms_content']) ? 'error' : '' ?>"  style="<?= ($type == 'SMS' || $type == 'Both') ? 'display: block' : 'display:none'; ?>">
        ...
        <div class="emailtp tp <?php echo isset($errors['email_subject']) ? 'error' : '' ?>"  style="<?= ($type == 'Email' || $type == 'Both') ? 'display: block' : 'display:none'; ?>">
        ...
        <div class="emailtp tp <?php echo isset($errors['email_content']) ? 'error' : '' ?>" style="<?= ($type == 'Email' || $type == 'Both') ? 'display: block' : 'display:none'; ?>">
          <div class="emailtp tp form-group">
      ...
      <div class="form-group" style="margin-top:20px;">
        ...
        <div class="col-md-4"> 
          ...
          <button type="button" name="cancel" id="cancel" class="btn btn-default" onclick="parent.$.colorbox.close();">Cancel</button>
        </div>
      </div>

                ...
                <div class="panel panel-default product_detail_panel panel-<?= $panel_color ?>"
                    ...
                    <div class="panel-heading ">
                        <h4 class="mn text-white">
                            ...
                            <!-- <button type="button" class="pull-right text-white btn_hide_product_detail2 fs20" data-ws_id="<?= $product_row['ws_id']; ?>">x</button> -->
                        </h4>
                    </div>
                    <div class="space p-5">
                        &nbsp;
                        ...
                        <table class="<?= $table_class ?> table-<?= $panel_color ?>">
                            ...
                            <tr>
                                ...
                                <td class="text-center icons">
                                    ...
                                    <a href="javascript:void(0);" data-href="<?= $HOST ?>/id_card_popup.php?ws_id=<?= md5($product_row['ws_id']); ?>&user_type=Admin&user_id=<?=$_SESSION['admin']['id']?>"

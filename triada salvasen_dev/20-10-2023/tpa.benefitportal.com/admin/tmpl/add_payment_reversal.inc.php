            ...
            <div class="phone-control-wrap ">
              <div class="phone-addon text-left">
                <div class="form-group height_auto mn">
                  <input class="listing_search" name="order_id" id="order_id" type="text"/>
...
$(document).ready(function(){
  ...
  initSelectizeDropDown('order_id','ReverseOrderID',<?php echo $_BOOTSTRAP_TAGS_MIN_LENGTH; ?>);
  var orderSelectize = $("#order_id")[0].selectize;
  var odrId = "<?=$odrId?>";
  if(odrId > 0){
    var odrDispId = "<?=$odrDispId?>";
    orderSelectize.addOption({
        text:odrDispId,
        value: odrId
    });
    orderSelectize.setValue(odrId);

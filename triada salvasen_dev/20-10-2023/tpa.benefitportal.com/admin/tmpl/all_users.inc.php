...
<div class="searchdiv"> 
  <div class="panel panel-default"> 
      <div class="preface">
        ...
        <div class="preface_alluser m-b-20 clearfix">
          <div class=" col-md-4 col-md-offset-4 ">
            <form method="GET" action="all_users.php" id="all_usersFrm" name="all_usersFrm" role="search" class=" all_user_srch">
                ...
                <input type="hidden" name="sort" id="g_sort_column" value="<?=$SortBy;?>" />
                <input type="hidden" name="direction" id="g_sort_direction" value="<?=$SortDirection;?>" />
 -->
          ...
          <!-- <div class="col-md-4 ">
          	<a href="global_activity_history.php" class="btn btn-info pull-right">Global Activity History</a>
          </div> -->
        </div>
       	<div class="clearfix"></div>
<?php if ($total_admins > 0 || $total_agents > 0  || $total_groups > 0 || $total_customers > 0  || $total_leads > 0 || $total_participants > 0) { ?>
...
<script type="text/javascript">
  $(document).ready(function() {
    var execute=function(){
      var activeelem=$('a.gsch_page.active').attr('href');
      if(activeelem=='global_participants.php')
      {
        fRefresh();
      }
    }

<div class="inner_box m-b-30">
    ...
    <ul class="nav nav-tabs tabs customtab nav-noscroll" role="tablist" id="pricingTypeTabEnrollee">
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="manual_matrix">
            ...
            <div class="row">
                ...
                <div class="clearfix"></div>
                <div class="col-sm-6 col-md-4 1PriceDiv" style="<?= !empty($price_control) && in_array(1,$price_control) ? '' : 'display: none' ?>">
                ...
                <div class="col-sm-3 col-md-3 2PriceDiv" style="<?= !empty($price_control) && in_array(2,$price_control) ? '' : 'display: none' ?>">
                ...
                <div class="col-sm-3 col-md-3 4PriceDiv" style="<?= !empty($price_control) && in_array(4,$price_control) ? '' : 'display: none' ?>">
                ...
                <div class="col-sm-12  7PriceDiv" style="<?= !empty($price_control) && in_array(7,$price_control) ? '' : 'display: none' ?>">
                ...
                <div class="col-sm-12  8PriceDiv" style="<?= !empty($price_control) && in_array(8,$price_control) ? '' : 'display: none' ?>">
                ...
                <div class="col-sm-6 col-md-2 5PriceDiv" style="<?= !empty($price_control) && in_array(5,$price_control) ? '' : 'display: none' ?>">
                ...
                <div class="col-sm-6 col-md-3 6PriceDiv" style="<?= !empty($price_control) && in_array(6,$price_control) ? '' : 'display: none' ?>">
                ...
                <div class="col-sm-12 9PriceDiv" style="<?= !empty($price_control) && in_array(9,$price_control) ? '' : 'display: none' ?>">
                ...
                <div class="col-sm-6 col-md-2 3PriceDiv" style="<?= !empty($price_control) && in_array(3,$price_control) ? '' : 'display: none' ?>">
                ...
                <div class="col-sm-6 col-md-3 10PriceDiv" style="<?= !empty($price_control) && in_array(10,$price_control) ? '' : 'display: none' ?>">
                ...
                <div class="col-sm-6 col-md-3 spouseControlPriceDiv 12PriceDiv" style="<?= !empty($price_control) && in_array(12,$price_control) ? '' : 'display: none' ?>">
                ...
                <div class="col-sm-6 col-md-3 spouseControlPriceDiv 11PriceDiv" style="<?= !empty($price_control) && in_array(11,$price_control) ? '' : 'display: none' ?>">
                ...
                <div class="col-sm-6 col-md-3 spouseControlPriceDiv 15PriceDiv" style="<?= !empty($price_control) && in_array(15,$price_control) ? '' : 'display: none' ?>">
                ...
                <div class="col-sm-6 col-md-2 spouseControlPriceDiv 16PriceDiv" style="<?= !empty($price_control) && in_array(16,$price_control) ? '' : 'display: none' ?>">
                ...
                <div class="col-sm-6 col-md-3 spouseControlPriceDiv 13PriceDiv" style="<?= !empty($price_control) && in_array(13,$price_control) ? '' : 'display: none' ?>">
                ...
                <div class="col-sm-6 col-md-3 spouseControlPriceDiv 14PriceDiv" style="<?= !empty($price_control) && in_array(14,$price_control) ? '' : 'display: none' ?>">
                ...
                <div class="col-sm-6 col-md-4 17PriceDiv" style="<?= !empty($price_control) && in_array(17,$price_control) ? '' : 'display: none' ?>">
        ...
        <div role="tabpanel" class="tab-pane" id="csv_matrix_tab">
            <div class="csv_matrix_tab">
                ...
                <div id="inline_content" style="display: none;">
                    <div class="col-sm-6">
                       <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="matrixPlanTypeCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                    ...
                    <div class="col-sm-6 1PriceDiv" style="<?= !empty($price_control) && in_array(1,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                <span class="input-group-addon"><strong>Age From</strong></span>
                                <div class="pr">
                                    <select name="age_fromCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 1PriceDiv" style="<?= !empty($price_control) && in_array(1,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="age_toCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 2PriceDiv" style="<?= !empty($price_control) && in_array(2,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                <span class="input-group-addon"><strong>State</strong></span>
                                <div class="pr">
                                    <select name="stateCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 4PriceDiv" style="<?= !empty($price_control) && in_array(4,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                <span class="input-group-addon"><strong>Gender</strong></span>
                                <div class="pr">
                                    <select name="genderCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 7PriceDiv" style="<?= !empty($price_control) && in_array(7,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                <span class="input-group-addon"><strong>Height BY</strong></span>
                                <div class="pr">
                                    <select name="height_byCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 7PriceDiv" style="<?= !empty($price_control) && in_array(7,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="height_feetCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 7PriceDiv" style="<?= !empty($price_control) && in_array(7,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="height_inchCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 7PriceDiv" style="<?= !empty($price_control) && in_array(7,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="height_feet_toCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 7PriceDiv" style="<?= !empty($price_control) && in_array(7,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="height_inch_toCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 8PriceDiv" style="<?= !empty($price_control) && in_array(8,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                <span class="input-group-addon"><strong>Weight By</strong></span>
                                <div class="pr">
                                    <select name="weight_byCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 8PriceDiv" style="<?= !empty($price_control) && in_array(8,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="weightCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 8PriceDiv" style="<?= !empty($price_control) && in_array(8,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="weight_toCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 5PriceDiv" style="<?= !empty($price_control) && in_array(5,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                <span class="input-group-addon"><strong>Smoking Status</strong></span>
                                <div class="pr">
                                    <select name="smoking_statusCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 6PriceDiv" style="<?= !empty($price_control) && in_array(6,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                <span class="input-group-addon"><strong>Tobacco Status</strong></span>
                                <div class="pr">
                                    <select name="tobacco_statusCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 9PriceDiv" style="<?= !empty($price_control) && in_array(9,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                <span class="input-group-addon"><strong>Children By</strong></span>
                                <div class="pr">
                                    <select name="no_of_children_byCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 9PriceDiv" style="<?= !empty($price_control) && in_array(9,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="no_of_childrenCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 9PriceDiv" style="<?= !empty($price_control) && in_array(9,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="no_of_children_toCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 3PriceDiv" style="<?= !empty($price_control) && in_array(3,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                <span class="input-group-addon"><strong>Zip Code</strong></span>
                                <div class="pr">
                                    <select name="zipCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 10PriceDiv" style="<?= !empty($price_control) && in_array(10,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                <span class="input-group-addon"><strong>Has Spouse</strong></span>
                                <div class="pr">
                                    <select name="has_spouseCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 spouseControlPriceDiv 12PriceDiv" style="<?= !empty($price_control) && in_array(12,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                <span class="input-group-addon"><strong>Spouse Gender</strong></span>
                                <div class="pr">
                                    <select name="spouse_genderCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 spouseControlPriceDiv 11PriceDiv" style="<?= !empty($price_control) && in_array(11,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                <span class="input-group-addon"><strong>Spouse Age From</strong></span>
                                <div class="pr">
                                    <select name="spouse_age_fromCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 spouseControlPriceDiv 11PriceDiv" style="<?= !empty($price_control) && in_array(11,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="spouse_age_toCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 spouseControlPriceDiv 15PriceDiv" style="<?= !empty($price_control) && in_array(15,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                <span class="input-group-addon"><strong>Spouse Height Feet</strong></span>
                                <div class="pr">
                                    <select name="spouse_height_feetCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 spouseControlPriceDiv 15PriceDiv" style="<?= !empty($price_control) && in_array(15,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="spouse_height_inchCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 spouseControlPriceDiv 16PriceDiv" style="<?= !empty($price_control) && in_array(16,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                <span class="input-group-addon"><strong>Spouse Weight</strong></span>
                                <div class="pr">
                                    <select name="spouse_weightCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 spouseControlPriceDiv 16PriceDiv" style="<?= !empty($price_control) && in_array(16,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="spouse_weight_typeCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 spouseControlPriceDiv 13PriceDiv" style="<?= !empty($price_control) && in_array(13,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                <span class="input-group-addon"><strong>Spouse Smoking Status</strong></span>
                                <div class="pr">
                                    <select name="spouse_smoking_statusCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 spouseControlPriceDiv 14PriceDiv" style="<?= !empty($price_control) && in_array(14,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                <span class="input-group-addon"><strong>Spouse Tobacco Status</strong></span>
                                <div class="pr">
                                    <select name="spouse_tobacco_statusCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6 17PriceDiv" style="<?= !empty($price_control) && in_array(17,$price_control) ? '' : 'display: none' ?>">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                <span class="input-group-addon"><strong>Benefit Amount</strong></span>
                                <div class="pr">
                                    <select name="benefit_amountCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="pricing_matrix_priceCSVRetail" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="pricing_matrix_priceCSVNonCommissionable" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="pricing_matrix_priceCSVCommissionable" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="pricing_matrix_effective_dateCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group height_auto">
                            <div class="input-group">
                                ...
                                <div class="pr">
                                    <select name="pricing_matrix_termination_dateCSV" class="select_field">
                                        <option value="" hidden selected="selected"></option>
                                    </select>
                                    <label>Select CSV Column</label>
                                </div>

...
<?php } else { ?>
    <form id="top_performing_agents_frm_search" action="<?=$ADMIN_HOST?>/top_performing_agents_v2.php" method="GET" class="sform">
    ...
    <div id="top_performing_agents_ajax_data"></div>

    <script type="text/javascript">
        $(document).ready(function () {
            top_performing_agents_ajax_submit();
            $(document).off('click','#top_performing_agents_ajax_data .live-link a');
            $(document).on('click','#top_performing_agents_ajax_data .live-link a',function(e){
                e.preventDefault();
                $('#ajax_loader').show();
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        $('#ajax_loader').hide();
                        $('#top_performing_agents_ajax_data').html(res).show();
                    }
                });
        ...
        function top_performing_agents_ajax_submit() {
            $('#ajax_loader').show();
            $('#top_performing_agents_is_ajaxed').val('1');

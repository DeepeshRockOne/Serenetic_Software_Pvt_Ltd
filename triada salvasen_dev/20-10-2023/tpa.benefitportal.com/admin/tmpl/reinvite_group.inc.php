<div class="panel panel-default panel-block mn reinvite_user">
   <div class="panel-heading">
      <div class="panel-title">
         <h4 class="mn">
         <i class="fa fa-link"></i>&nbsp; <?php echo $groupName; ?> - <span class="fw300">Group Application Link</span></h1>
      </div>
   </div>
   ...
   <?php }else{ ?>
   <div class="panel-body" >
      <p>The Group Application link for <?= $groupName ?> has expired. Please click "Generate Link" button below  for a new link that you can copy and share or send directly to this Group here.</p>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $("#generate_link").click(function(){
      ...
      $('#ajax_loader').show();
      $.ajax({
        url: 'ajax_reinvite_group_generate_link.php',
        data: 'id=' + customer_id,
        type: 'GET',
        dataType: 'json',

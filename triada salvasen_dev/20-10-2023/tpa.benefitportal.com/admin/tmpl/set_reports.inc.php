   ...
   <div class="panel-body">
      <div class="phone-control-wrap ">
         ...
         <div class="phone-addon text-left">
            <p class="fs14 m-b-20">Select a report category below to view certain reports in that categoory.</p>
...
<div class="panel panel-default panel-block report_panel">
   <div class="panel-body">
      <h4 class="m-t-0 m-b-20">
            Report Categories
            <?php if(in_array($_SESSION['admin']['type'],array("Executive","Development"))) { ?>
            <a href="report_listing.php" class="btn btn-action pull-right">Manage Reports</a>
            <?php } ?>
      </h4>
      <div class="row">
         <div class="col-sm-3">
                                        ...
                                        foreach ($category_res as $key => $category_row) {
                                            if(!empty($category_row['reports'])) {
                                                foreach ($category_row['reports'] as $report_row) {
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td><a href="javascript:void(0);" class="fw500 text-action"><?=$report_row['report_name'];?></td>
                                                        <td class="text-center icons">
                                                         ...
                                                         <td class="icons text-right">
                                                            <?php if($report_row['report_key'] == "admin_payment_transaction_report") { ?>
                                                            <a href="<?=$HOST?>/quick_report_sales_summary.php?user_id=<?=md5($_SESSION['admin']['id'])?>&user_type=Admin" data-toggle="tooltip" data-trigger="hover" data-placement="top" title="View Quick Sales Summary" class="view_quick_report_sales_summary"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                            <?php } ?>

                                                            <?php if($report_row['is_allow_schedule'] == "Y") { ?>
                                                            <a href="<?=$HOST?>/report_schedule.php?user_id=<?=md5($_SESSION['admin']['id'])?>&user_type=Admin&id=<?=md5($report_row['id']);?>" data-toggle="tooltip" data-trigger="hover" data-placement="top" title="Schedule Delivery" class="report_schedule"><i class="fa fa-calendar" aria-hidden="true"></i>
                                                            </a>
                                                            <?php } ?>

<div class="panel panel-default" style="min-height: 400px !important;">
    <div class="panel-heading">
        <h4 class="mn">Error Log <span class="fw300"><?php echo  $file_row['display_title'] ?> (<?= date('m/d/Y', strtotime($file_row['created_at'])) ?>)</span></h4>
    </div>
        ...
        <div class="table-responsive">
            ...
            <?php if (count($fetch_rows) > 0) { ?>
                <div class="text-center">
                    <a href="import_error_log.php?id=<?= $id ?>&export=export_excel" class="red-link"><i class="fa fa-download"></i> Export</a>
                </div>
            <?php } ?>
        </div>
    </div>

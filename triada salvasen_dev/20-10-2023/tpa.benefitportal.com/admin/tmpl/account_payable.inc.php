...
<div class="panel panel-default panel-block">
    <div class="panel-body">
        <div class="clearfix tbl_filter m-b-15">
            <div class="pull-left">
                <h4 class="m-t-7">Payables</h4>
            </div>
            <div class="pull-right">
                <a href="regenerate_payable.php" class="btn btn-action">Regenerate Payables</a>
            </div>
        </div>
        <div class="table-responsive">
            <table class="<?=$table_class?>">
    ...
    <div class="panel-right">
        ...
        <div class="panel-wrapper collapse in">
            <div class="panel-body theme-form">
                <form action="account_payable.php" name="payableFrm" id="payableFrm" autocomplete="off">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" name="payee_id" id="payee_id" class="form-control listing_search" value="<?=checkIsset($payee_id)?>">
                    ...
                    <div class="panel-footer clearfix">
                        ...
                        <button type="button" class="btn btn-info btn-outline" name="" id="" onClick="window.location.href = 'account_payable.php?viewPayable=allPayable'"> <i class="fa fa-search-plus"></i> View All </button>

<div class="panel panel-default panel-block schedule_popup">
	<form name="frmSchedule" id="frmSchedule" action="" method="POST">
		...
		<div class="panel-body theme-form">
			<div class="eligibility_schedule">
				...
				<div class="row theme-form">
					...
					<div class="col-xs-6 frequency_div" style="display:<?=($schedule_type == '' || $schedule_type == 'daily' || $schedule_type == 'weekly')?"block":"none"?>">
						<div class="phone-control-wrap">
							...
							<div class="phone-addon w-30">
								<div class="form-group  frequency_text">
				...
				<div class="row">
					...
					<div class="row div_monthly" style="display:<?=$schedule_type == 'monthly' || $schedule_type == 'yearly'?"block":"none"?>">
						<div class="col-xs-6">
							<p>
								...
								<label class="mn w-100">
									<div class="phone-control-wrap">
										...
										<div class="phone-addon theme-form on_date" style="display: <?=$schedule_end_type == 'on_date' ? 'block' : 'none'; ?>">
											<div class="pr">
												<input type="text" class="form-control datepicker" name="schedule_on_date" value="<?=$schedule_end_date != '' ? $schedule_end_date : ''?>">
				...
				<div style="display: none;">
					...
					<div class="m-b-25">
						<div class="btn-group" data-toggle="buttons">
	                        ...
	                        <input type="radio" class="file_type js-switch" name="file_type" value="full_file" checked="checked"> Full File
	                      </label>
	                        <label class='btn btn-info <?=$file_type == "schedule_change_file" ? "active":""?>'>
	                        <input type="radio" class="file_type js-switch" name="file_type" value="schedule_change_file"> Add/Change/Delete File
	                      </label>
			...
			<p class="fw500">Filter Options</p>
			<div class="row theme-form">
				<div class="col-xs-6">
			        <div class="form-group ">
			            <select class="filter_fields form-control" name="added_date" id="added_date">
			                <option value="prior_month" selected>Prior Month</option>
			            </select>
			            <label>Date</label>
			            <p class="error"><span id="error_filter_added_date"></span></p>
			        </div>
			    </div>
...
<script type="text/javascript">
	$(document).ready(function() {
	  ...
	  $(document).on("click","#schedule",function(){
	    eligibility_schedule($(this));
	  });

	});

function eligibility_schedule(btn_obj) {
    btn_obj.prop('disabled',true);
    $("#ajax_loader").show();
    $('.error span').html('');

    $.ajax({
        url: '<?= $HOST ?>/admin/ajax_billing_schedule.php',
        ...
        success: function(res) {
            ...
            if (res.status == "success") {
                window.parent.setNotifySuccess("Billing File Scheduled Successfully");
				setTimeout(function(){

               ...
               <div class="row">
                  <div class="col-sm-9">
                     <div class="form-group">
                        <input class="form-control" type="text" value="<?=$aae_link?>" readonly="readonly" id="copytext">
                        <label>Click on link below to copy and share</label>
                     </div>
                  </div>
                  <div class="col-sm-3">
                     <div class="form-group">
                        <a class="btn btn-action btn-block" id="copyingg" data-clipboard-target="#copytext">COPY LINK</a>
                     </div>
                  </div>
                  <div class="col-sm-9">
                     <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        initCKEditor("email_content",false,"125px");

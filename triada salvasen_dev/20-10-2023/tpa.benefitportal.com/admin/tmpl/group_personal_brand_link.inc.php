     ...
     <div class="row">
       <div class="col-sm-12">
         <div class="form-group height_auto">
           <label class="mn label-input"><input type="checkbox" id="display_in_member" name="display_in_member" value="Y" <?= $display_in_member == 'Y' ? 'checked' : '' ?>> Check this box if you do not want display name, display phone, or display email shown as a point of contact.</label>
         </div>
       </div>
       <div class="col-sm-6">

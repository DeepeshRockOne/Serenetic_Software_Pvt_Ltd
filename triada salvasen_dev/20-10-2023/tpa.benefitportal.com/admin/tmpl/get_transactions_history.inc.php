...
<div class="table-responsive">
    ...
    <?php if ($total_rows > 0) {?>
        <?php foreach ($fetch_rows as $rows) { 
            $link = $ADMIN_HOST;
            $link .= $rows['type'] == 'Agent' ? '/agent_detail_v1.php' : '/groups_details.php';
        ...
        <tr>
            ...
            <td>
                <a href="<?=$link?>?id=<?=md5($rows['agent_id'])?>" target="_blank" class="fw500 text-action"><?=$rows['rep_id']?></a><br><?=$rows['fname'].' '.$rows['lname']?>
            </td>
            <td>
    ...
    <?php } }else echo "<tr><td colspan='8'>No record Found!</td></tr>"; ?>
        ...
        <tr>
            <td>
                <a href="javascript:void(0);" class="fw500 text-action">2222222</a><br>
                04/28/2019
            </td>
            <td>
                <a href="javascript:void(0);" class="fw500 text-action">A000000</a><br>
                Punit Ladani
            </td>
            <td>
                Renewal<br>
                <a href="javascript:void(0);" class="fw500 text-action">2342342342</a>
            </td>
            <td>Visa *5555</td>
            ...
            <td>$12.95</td>
            <td class="icons">
                <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="Send Receipt"><i class="material-icons">send</i></a>
            </td>
        </tr> -->
    </tbody>
    <?php if ($total_rows > 0) { ?>

         ...
         <div class="panel-wrapper collapse in">
            <div class="panel-body theme-form">
               <div class="row">
                     ...
                     <div class="form-group ">
                        <select class="se_multiple_select listing_search" id="agency_name" name="agency_name[]"  multiple="multiple">
                           <?php if(!empty($agency_res)){ 
                              ...
                              ?>
                              <option value="<?=$acRes['id']?>"><?=$acRes['rep_id'].' - '.$acRes['agencyNameDis']?></option>
                           <?php }} ?>
                        </select>
                        <label>Agency</label>
                     </div>
                  ...
                  <div class="col-sm-6">
                     <div class="form-group height_auto">
                        <input name="member_id" id="member_id" type="text" class="listing_search" value=""/>
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
    dropdown_pagination('ajax_data')
      $("#agency_name, #interaction_type").multipleSelect({
         selectAll: false,
         filter: true
      });
      ajax_submit();

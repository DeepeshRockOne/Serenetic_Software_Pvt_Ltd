...
<div class="panel panel-default panel-block preface comunipart panel-shadowless">
  <div id="sec_acord">
    <div id="open_account_search">
      <form action="ajax_activity_feed_admin.php?id=<?php echo $_REQUEST['id']; ?>&for=admin" method="POST" id="acc_feed_search_form" class="theme-form">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $(document).on('click','#export_activity',function(){
      confirm_export_data(function() {
          ...
          $.ajax({
            url: 'ajax_activity_feed_admin.php',
            type: 'POST',
            data: {
  ...
  function ajax_load_activity_feed() {
    ...
    $.ajax({
      url: "ajax_activity_feed_admin.php",
      data: {id: '<?= $_REQUEST['id'] ?>',user_type:'Admin',activity_type:activity_type,keyword_search:keyword_search,acc_his_custom_date:acc_his_custom_date,acc_his_fromdate:acc_his_fromdate,acc_his_todate:acc_his_todate,for:'Admin'},
      type: 'POST',
      success: function(res) {
        $('#ajax_loader').hide();
  ...
  function ajax_reload_activity_feed() {
    ...
    $.ajax({
      url: "ajax_activity_feed_admin.php",
      data: {id: '<?= $_REQUEST['id'] ?>',user_type:'Admin',for:'Admin'},
      type: 'POST',
      success: function(res) {
        $('#ajax_loader').hide();
        $("#sec_acct_his").html(res);

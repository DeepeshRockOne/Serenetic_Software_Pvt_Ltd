...
$options = array(
    'results_per_page' =>6,
    'url' => 'agent_monthly_commission.php?' . $query_string,
    'db_handle' => $pdo->dbh,
...
$options = array_merge($pageinate_html, $options);
    ...
    FROM commission cs
    WHERE cs.commission_duration='monthly' AND  cs.is_deleted = 'N' " . $incr . " GROUP BY cs.pay_period
    ...
    include_once 'tmpl/agent_monthly_commission.inc.php';

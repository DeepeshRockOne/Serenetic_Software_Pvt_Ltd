...
if(!empty($drow)){
  ...
  $prow = $pdo->select($query,array(':id'=>$id));
  ...
  //************* Activity Code Start *************
    $description['ac_message'] =array(
      ...
      'ac_message_1' =>' Deleted Vendors ',
      'ac_red_2'=>array(
        //'href'=> '',
        'title'=>$drow['display_id'],
      ),
    ); 
    activity_feed(3, $_SESSION['admin']['id'], 'Admin', $id, 'vendor','Admin Deleted Vendor ', $_SESSION['admin']['fname'],$_SESSION['admin']['lname'],json_encode($description));
  //************* Activity Code End *************

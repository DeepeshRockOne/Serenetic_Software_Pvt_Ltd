...
$sqlListBill = "SELECT lb.id,lb.notes,lb.customer_id FROM list_bills lb WHERE md5(id)=:id";
...
activity_feed(3, $_SESSION['admin']['id'],'Admin',$resListBill['id'] , 'list_bills', 'List Bill Note Updated', $_SESSION['admin']['fname'], $_SESSION['admin']['lname'], json_encode($ac_description));

...
$contact_person_fname = isset($_POST['contact_person_fname']) ? $_POST['contact_person_fname'] : '';
$contact_person_lname = isset($_POST['contact_person_lname']) ? $_POST['contact_person_lname'] : '';
$contact_person_email = checkIsset($_POST['contact_person_email']);
$cell_phone = isset($_POST['contact_person_phone']) ? $_POST['contact_person_phone'] : '';
...
if ($validate->isValid()) {
    ...
    if(!empty($group_sql)){
      ...
      $enrollment_url = $ADMIN_HOST.'/invite_group.php';
      $extra['user_admin_id'] = $_SESSION['admin']['id'];
      ...
      $description['ac_email_link'] = array(
        'email_popup'=>['text'=>'Email:','label'=>'61','href'=>$email_link,'class'=>'email_content_popup','title'=>'','id'=>'','on_click'=>'','data_toggle'=>''],
      ...
      $description['ac_sms_link'] = array(
        'sms_popup'=>['text'=>'SMS:','label'=>'61','href'=>$sms_link,'class'=>'email_content_popup','title'=>'','id'=>'','on_click'=>'','data_toggle'=>''],
      ...
      $description['invited_by'] = 'Invited By:'.$_SESSION['admin']['fname'].' '.$_SESSION['admin']['lname'].' ('.$_SESSION['admin']['display_id'].')';
      ...
      activity_feed(3, $_SESSION['admin']['id'], 'admin', $group_id, 'customer', 'Invited Group', $contact_person_fname, $contact_person_lname,json_encode($description), $enrollment_url, json_encode($extra));
    }

...
if ($is_transaction_ajaxed) {
    ...
    if(!empty($customer_id)){
        ...
        $incr .= ' AND t.customer_id = :customer_id';
    }
    ...
    try {
        $sel_sql = "SELECT md5(t.id) as t_id,md5(o.id) as o_id,o.display_id,t.created_at,o.is_renewal,o.customer_id,IF(t.transaction_status='Chargeback',tt.transaction_id,t.transaction_id) AS transaction_id,t.transaction_status,t.credit,t.debit,s.id as agent_id,s.fname,s.lname,s.rep_id,

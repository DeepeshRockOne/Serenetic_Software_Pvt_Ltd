...
include_once dirname(__FILE__) . '/layout/start.inc.php';
    ...
    $passcode = checkIsset($_POST['passcode']) == 'Y' ? $_POST['passcode'] : 'Y' ;
    ...
    function activity_feed_account_manager($group_id,$msg='',$extra = array()){
        ...
        activity_feed(3,$group_name['id'], 'Group' , $group_name['id'], 'Group Account Manager', 'Group Account Manager',$_SESSION['admin']['name'],"",$desc);
    }

...
$query = "SELECT id, status FROM triggers WHERE id =:id";
...
if ($srow) {
  ...
  /* Code for audit log*/
      ...
      audit_log_new($user_data, $_SESSION['admin']['id'], "Admin", "Trigger Status Was Changed And Id is ".$id, $result_audit_customer_data, $update_params_new, 'trigger status was changed by admin');

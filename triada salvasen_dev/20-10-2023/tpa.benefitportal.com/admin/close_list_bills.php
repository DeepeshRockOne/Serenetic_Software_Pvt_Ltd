...
$options = array(
    ...
    'url' => 'close_list_bills.php?is_ajaxed=1&' . $query_string,
    'db_handle' => $pdo->dbh,
...
if ($is_ajaxed) {
  try {
    $sel_sql = "SELECT lb.*,g.rep_id,g.business_name,o.created_at as payment_date,o.transaction_id,o.payment_type,obi.last_cc_ach_no,o.id as order_id,md5(lb.id) as secured,gc.name as group_company_name
             FROM list_bills lb
             ...
             LEFT JOIN orders o ON (o.id=lb.order_id)
             LEFT JOIN order_billing_info obi ON (o.id = obi.order_id)
  ...
  include_once 'tmpl/close_list_bills.inc.php';
  exit;
}
?>
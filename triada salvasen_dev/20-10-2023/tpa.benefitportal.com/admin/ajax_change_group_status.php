    ...
    if (!empty($srow)){
      ...
      //OP29-843 Update For Terminated Status Start
        if(!empty($terminationDate) && strtolower($status) =='terminated'){
          ...
          updateGroupMemberPolicy($srow['id'],$terminationDate,'Policy Change',array(),$generateListBill,'Admin',$sponsor_billing_method);
        }
      ...
      activity_feed(3,$_SESSION['admin']['id'], 'Admin' , $srow['id'], 'Group', 'Status Updated',$_SESSION['admin']['name'],"",$desc, "", "");

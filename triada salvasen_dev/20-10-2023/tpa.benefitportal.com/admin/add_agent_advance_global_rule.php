...
if(!empty($advRuleId)){
  ...
  if(!empty($advRes['id'])){
    ...
    //************* Activity Code Start *************
      ...
      'ac_red_2'=>array(
      'href'=> $ADMIN_HOST.'/add_agent_advance_global_rule.php?advRuleId='.md5($advRes['id']),
...
$template = 'add_agent_advance_global_rule.inc.php';

...
include_once 'layout/start.inc.php';
    ...
    if(isset($_POST['type']) == 'delete' && !empty($_POST['interaction_detail_id'])){
        ...
        activity_feed(3,$_SESSION['admin']['id'], 'Admin' , $group_name['id'], 'Group', 'Interaction Deleted.',$_SESSION['admin']['name'],"",$desc);
    ...
    if($validate->isValid()){
            ...
            if(!empty($interaction_detail) && $interaction_detail['id'] > 0){
                ...
                activity_feed(3,$_SESSION['admin']['id'], 'Admin' , $group_id, 'Group', 'Interaction Updated.',$_SESSION['admin']['name'],"",$desc);
                ...
                $desc=json_encode($description);
                activity_feed(3,$_SESSION['admin']['id'], 'Admin' , $group_id, 'Group', 'Interaction Created.',$_SESSION['admin']['name'],"",$desc);

...
$principal_beneficiary_number = isset($_POST['principal_beneficiary_field_number'])? explode("_", $_POST['principal_beneficiary_field_number']):array();

$number = $principal_beneficiary_number[0];
$display_number = $principal_beneficiary_number[1];

$response['number']=$number;


$principal_existing_dependent = !empty($_POST['principal_existing_dependent']) ? $_POST['principal_existing_dependent'] : array();

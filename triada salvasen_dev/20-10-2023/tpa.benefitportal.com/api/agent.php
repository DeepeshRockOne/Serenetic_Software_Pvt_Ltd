<?php
$agent_sql = "SELECT c.rep_id,c.fname,c.lname,c.birth_date,c.status,c.address,c.address_2,c.city,c.zip,
				...
				WHERE c.is_deleted = 'N' AND c.type = 'Agent'";

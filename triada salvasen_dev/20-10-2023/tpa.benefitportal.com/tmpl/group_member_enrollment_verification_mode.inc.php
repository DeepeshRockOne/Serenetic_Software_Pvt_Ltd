  ...
  <div class="verify_opt" >  
    ...
    <!-- Electronic Signature by member start (option-3) -->
      <div id="direct_member" style="<?=$is_direct_application=="Y"?'':'display: none'?>;">
         <hr>
         <div class="d-clearfix"  id="passwordDiv">          
          <div class="clearfix"></div>
            ...
            <table class="<?=$table_class?> table-black">
               <thead>
                  <tr>
                     <th>
                        <div class="w-90">
                           <input type="checkbox" name="product_check_all" class="product_check_all" id="product_terms_check_all" >
                        </div>
                     </th>
                     <th>Category</th>
                     <th>Plan Name</th>
               ...
               <tbody id="terms_condition_prd_tbody">
               </tbody>
            </table>
            </div>
          <div class="clearfix"></div>
          ...
          <label class="m-b-30 m-t-15 label-input">
            <input type="checkbox" name="product_term_check[0]" id="product_term_check_0">
              <span>I acknowledge that I have read and agree to the <a href="javascript:void(0)" class="red-link terms_popup">terms and conditions</a> in this agreement.</span>
          ...
          <div class="m-b-30" id="joinderAgreementDiv" style="display: none;">
            <label class="mn label-input">
              ...
              <input type="checkbox" name="joinder_agreement_check" value="Y"><sapn>I acknowledge that I have read and agree to the <a href="javascript:void(0);" class="prd_agreement_popup fw500 red-link">Joinder Agreement</a>.</span>
            </label>

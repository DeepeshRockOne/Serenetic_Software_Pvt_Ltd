         ...
         <div class="panel gap_panel panel-default">
            <div class="panel-body theme-form">
               <form method="POST" id="home_pay_calculator">
                  <input type="hidden" name="homepay_zipcode" id="homepay_zipcode" value="">
                  <input type="hidden" name="homepay_products" id="homepay_products" value="">
                  <input type="hidden" name="homepay_plan_ids" id="homepay_plan_ids" value="">
                  ...
                  <div class="clearfix m-b-25">
                     ...
                     <label class="radio-inline">
                        <input type="radio" class='gap_payroll_type' name="gap_payroll_type" value="Salary" checked="checked">Salary
                     </label>
                  ...
                  <div class="clearfix m-b-25">
                     <label class="radio-inline">
                        <input type="radio" name="gap_marital_status"  value="single" <?= strtolower($gap_marital_status) == 'single' ? 'checked="checked"' : '' ?>>Single
                     </label>
                     <label class="radio-inline">
                        <input type="radio" name="gap_marital_status"  value="married" <?= strtolower($gap_marital_status) == 'married' ? 'checked="checked"' : '' ?>>Married
                     </label>
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" name="gap_pay_frequency" id="gap_pay_frequency" value="" class="form-control" readonly>
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           <select class="form-control" name="gap_default_allowances_federal">
                              <?php
                              for ($i = 0; $i < 13; $i++) {
                                 echo "<option value='" . $i . "' " . ($w4_no_of_allowances_field == $i ? 'selected' : '') . ">" . $i . "</option>";
                              }
                              ?>
                           </select>
                           <label>Federal</label>
                  ...
                  <p class="error" id="error_homepay_products"></p>
                  <p class="error gap_input_errors"></p>
               ...
               <div class="table-responsive">
                  <table class="table fs12 gap_table text-center">
                     <thead>
                        <tr>
                           <th></th>
                           <th>Without Triada</th>
                           <th class="bg-success text-white">With Triada</th>
                        </tr>
                     </thead>
                     <tbody>
                        <tr>
      ...
      <div class="col-md-6">
         <div class="form-group height_auto">
            <div class="input-group">
               <span class="input-group-addon"><i class="fa fa-usd"></i></span>
               <div class="pr">
                  <input type="text" class="form-control gap_payroll_type_hourly_wage" name="gap_payroll_type_hourly_wage[~index~]" id="gap_payroll_type_hourly_wage_~index~" data-index="~index~">
                  <label class="label-wrap">Hourly Wage</label>
               </div>
            </div>
...
<div id="pre_tax_deduct_content" style="display: none">
   <div class="theme-form tax_deduct_table tbl-header" id="table-cont1">
         <table cellspacing="0" cellpadding="0" width="100%" border="0">
            <thead>
               <tr>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        <tbody>
            ...
            <tr>
               ...
               <td><a href="javascript:void(0);" data-tax_type="pre_tax" id="pre_tax_deductions_done" class="btn btn-action-o deductions_done">Done</a></td>
            </tr>
        </tbody>
    </table>
</div>
      ...
      <tr class="pre_tax_deduction_row~temp~ pre_tax_deduction_row_~index~" data-index="~index~">
         <td>
            <div class="pr">
               ...
               <label class="label-wrap">Deduction Name</label>
               <p class="error" id="error_pre_tax_deduction_name_~index~"></p>
            </div>
         </td>
         <td>
            <div class="pr">
               <select name="pre_tax_deduction_method[~index~]" id="pre_tax_deduction_method_~index~" class="deduction_method_select" data-tax_type="pre_tax" data-index="~index~" data-none-selected-text="">
                  <option value=""></option>
         ...
         <td class="text-right"><strong class="row_total_amount" id="pre_tax_deduction_row_total_~index~">$0.00</strong> <a href="javascript:void(0);" id="pre_tax_deduction_remove_row_~index~" class="deduction_remove_row" data-tax_type="pre_tax" data-index="~index~">X</a></td>
      </tr>
   </tbody>
</table>
<!-- pre tax popup end -->
...
<div id="post_tax_deduct_content" style="display: none">
   <div class="theme-form tax_deduct_table tbl-header" id="table-cont2">
         <table cellspacing="0" cellpadding="0" width="100%" border="0">
            <thead>
               <tr>
                  <th>Deduction Name</th>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        <tbody>
            ...
            <tr>
               ...
               <td><a href="javascript:void(0);" data-tax_type="post_tax" class="btn btn-action-o deductions_done" id="post_tax_deductions_done">Done</a></td>
            </tr>
        </tbody>
    </table>
   </div>
...
<table style="display: none">
   <tbody id="post_tax_deduction_row_template">
      <tr class="post_tax_deduction_row~temp~ post_tax_deduction_row_~index~" data-index="~index~">
         ...
         <td>
            <div class="pr">
               <select name="post_tax_deduction_method[~index~]" id="post_tax_deduction_method_~index~" class="deduction_method_select" data-tax_type="post_tax" data-index="~index~" data-none-selected-text="">
                  <option value=""></option>
                  <option value="fixed_amount">$ Fixed Amount</option>
                  <option value="gross_pay">% Gross Pay</option>
               </select>
         ...
         <td class="text-right"><strong class="row_total_amount" id="post_tax_deduction_row_total_~index~">$0.00</strong> <a href="javascript:void(0);" id="post_tax_deduction_remove_row_~index~" class="deduction_remove_row" data-tax_type="post_tax" data-index="~index~">X</a></td>
      </tr>
   </tbody>
</table>
<!-- post tax popup end -->
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
      ...
      $hourDivCnt = 0;
      $primary_annual_salary = '<?=$primary_annual_salary?>';
      addSalaryDiv();
      $('#payroll_type_salary_div').show();
      $('.payroll_type_hourly_div').hide();
      $('#gap_payroll_type_salary').val($primary_annual_salary);
      if($primary_annual_salary !== ''){
         $('#gap_payroll_type_salary').addClass('has-value');
   ...
   $(document).on("change", ".deduction_method_select", function(e) {
      var $tax_type = $(this).data('tax_type');
      var $row_index = $(this).data('index');
      ...
      if($deduction_method != ''){
         ...
         $("#pre_tax_deduction_amount_"+$row_index).val(0);
      }
   });
   ...
   $(document).on("click", ".deductions_done", function(e) {
      ...
      $("." + $tax_type + "_deduct_click").trigger('click');
      $("#"+$tax_type+"_deduction_remove_row2_0").remove();
   });
   ...
   calculate_tax_deduction_row = function($tax_type, $row_index, $is_from_arr) {
      ...
      if ($gap_payroll_type == "Hourly") {
         ...
         } else if (pay_frequency == "WEEKLY" || pay_frequency == "Weekly") {
            $gross_income = $gross_income / 52;
         } else if (pay_frequency == "BI_WEEKLY" || pay_frequency == "Bi-Weekly") {
            $gross_income = $gross_income / 26;
         } else if (pay_frequency == "SEMI_MONTHLY" || pay_frequency == "Semi-Monthly") {
            $gross_income = $gross_income / 24;
         } else if (pay_frequency == "MONTHLY" || pay_frequency == "Monthly") {
   ...
   display_tax_deduction = function($tax_type) {
      ...
      $("." + $tax_type + "_deduction_row").each(function(index, ele) {
         ...
         if ($row_index >= 0) {
            ...
            deduction_html += "<td><a href='javascript:void(0);'  id='" + $tax_type + "_deduction_remove_row2_" + $row_index + "' class='text-action deduction_remove_row2'  data-tax_type='" + $tax_type + "' data-index='" + cnt + "'>X</a></td>";
            deduction_html += "</tr>";
            deduction_data[cnt] = {
   ...
   $(document).on('click', '#calculate_coverage', function(e) {
      e.preventDefault();
      calculateTakeHomePay('calculate_coverage');
     
   });

   function calculateTakeHomePay(from){
      $("#homepay_zipcode").val($("#primary_zip_coverage").val());
      $("#homepay_zipcode_form").val($("#primary_zip_coverage").val());
      var product_id = $("#product_list").val();
      var elected_bundle = $("#elected_bundle").val();
      $("#homepay_products").val(product_id);
      homepay_plan_ids = [];
      var plan_id = '';
      var product_price = parseFloat(0);
      var planName = '';
      if(product_id != "" && product_id != undefined){
         prd_list = product_id.split(',');
         $(prd_list).each(function(i,v){
            var productMatrix = $('#product_matrix_'+v).val();
            plan_id = productMatrix != '' && productMatrix!=undefined ? productMatrix : $('#bundle_product_matrix_'+elected_bundle+product_id).val();
            homepay_plan_ids.push(plan_id);
         });
      }

      $("#homepay_plan_ids").val(homepay_plan_ids.join());
      if(from != 'calculate_coverage'){
         var $preTax = 0;
         var $postTax = 0;
         $("#pre_tax_deduct_click").click();
         $("#post_tax_deduct_click").click();
         var product_id = $("#product_list").val();
         var prd_list = product_id!='' ? product_id.split(',') : [];

         $pre_tax_deductionsTemplate = parseF('<?=$pre_tax_deductions?>');

         if($pre_tax_deductionsTemplate != 0.00){
            prd_list.push('default_pre_tax');
         }
         $post_tax_deductionsTemplate = parseF('<?=$post_tax_deductions?>');
         if($post_tax_deductionsTemplate != 0.00){
            prd_list.push('default_post_tax');
         }
         
         if(prd_list.length > 0){
            $(prd_list).each(function(i,v){
               if(v == 'default_pre_tax' || v == 'default_post_tax'){
                  $rowData ={
                     deduction_name: v == 'default_pre_tax' ? 'Default PreTax' : 'Default PostTax',
                     deduction_method:'fixed_amount',
                     deduction_amount: v == 'default_pre_tax' ? parseF($pre_tax_deductionsTemplate) :  parseF($post_tax_deductionsTemplate),
                     deduction_row_total: v == 'default_pre_tax' ? parseF($pre_tax_deductionsTemplate) : parseF($post_tax_deductionsTemplate),
                  }
                  deductionType = (v == 'default_pre_tax' ? 'pre_tax' : 'post_tax');
               }else{
                  var displayProductPrice = $("#display_product_price_"+v).val();
                  var deduction = $("#product_benefit_tier_"+v).find(":selected").data('deduction');
                  var product_price = displayProductPrice !='' && displayProductPrice!=undefined ? displayProductPrice : $("#bundle_display_product_price_"+elected_bundle+v).val();
                  var deductionType = deduction !='' && deduction!=undefined ? deduction : $("#bundle_product_benefit_tier_"+elected_bundle+v).find(":selected").data('deduction');
                  planName = $("#product_name_"+v).text();
                  $rowData = {
                     deduction_name:planName,
                     deduction_method:'fixed_amount',
                     deduction_amount:parseF(product_price),
                     deduction_row_total:parseF(product_price)
                  };
               }
               if(deductionType == 'pre_tax'){
                  add_deduction_row($preTax, 'pre_tax', $rowData);
                  $preTax++;
               }else{
                  add_deduction_row($postTax, 'post_tax', $rowData);
                  $postTax++;
               }
            });
         }
         ...
         calculate_tax_deduction_total('pre_tax');
         $("#pre_tax_deductions_done").click();

         calculate_tax_deduction_total('post_tax');
         $("#post_tax_deductions_done").click();
         deleteRemoveIcon();
      }
      

       $('.gap_panel p.error').html("");
      var param = $('#home_pay_calculator').serializeArray();
      param.push({name:'api_key',value:'calculateTakeHomePay'});
      param.push({name:'leadId',value:'<?= isset($lead_id)?$lead_id:0?>'});
      $.ajax({
         // url: '<?= $HOST ?>/data.json',
            ...
            if (res.status == 'Success') {
               if (typeof(res.data) !== 'undefined') {
                  if (typeof(res.data['calculation_data']) !== 'undefined') {
                     ...
                     $.each(param, function(ind, val){
                        $("#"+val.name+'_form').val(val.value);
                     });
                     $.each($calculation_data, function(ind, val) {
                        if (ind == 'with_gap_take_home') {
                           // parent.$('#with_gap_take_home').html(val);
                           $(".gapTakeHomeAmt").html(val);
                        }else if(ind == 'gross_income') {
                           $("#with_triada_gross_income").html(val);
                           $("#without_triada_gross_income").html(val);
                  ...
                  if (typeof(res.data['curlResponse']) !== 'undefined') {
                     if (typeof(res.data['curlResponse']['errors']) !== 'undefined') {
                        $tmpErrors = [];
                        $tmpErrorsText =  '';
                        $.each(res.data['curlResponse']['errors'], function(ind, val) {
                           if($.inArray(val.message,$tmpErrors) == -1){
                              $tmpErrors.push(val.message);
                              $tmpErrorsText += val.message;
                           }
                        });
                        $('.gap_input_errors').html($tmpErrorsText);
                     }
                  }
               }
            } else {
   ...
   function deleteRemoveIcon(){
      var product_id = $("#product_list").val();
      var electedBundle = $("#elected_bundle").val();
      var prd_list = product_id!='' ? product_id.split(',') : [];
      $pre_tax_deductionsTemplate = '<?=$pre_tax_deductions?>';
      if($pre_tax_deductionsTemplate != 0.00){
         prd_list.push('default_pre_tax');
      }
      $post_tax_deductionsTemplate = '<?=$post_tax_deductions?>';
      if($post_tax_deductionsTemplate != 0.00){
         prd_list.push('default_post_tax');
      }
      ...
      if(prd_list.length > 0){
         ...
         $(prd_list).each(function(i,v){
            var deduction = $("#product_benefit_tier_"+v).find(":selected").data('deduction');
            var deductionType = deduction !='' && deduction!=undefined ? deduction : $("#bundle_product_benefit_tier_"+electedBundle+v).find(":selected").data('deduction');
            if(v == 'default_pre_tax' || v == 'default_post_tax'){
               deductionType =  (v == 'default_pre_tax' ? 'pre_tax' : 'post_tax');
            }
            if(deductionType == 'pre_tax'){
            ...
            $("#"+deductionType+"_deduction_remove_row2_"+k).remove();
            $("#"+deductionType+"_deduction_remove_row_"+k).remove();
            $("#"+deductionType+"_deduction_name_"+k).attr('readonly',true);
            $("#"+deductionType+"_deduction_method_"+k+" option[value='gross_pay']").remove();
            $("#"+deductionType+"_deduction_method_"+k).selectpicker('refresh');
            // $("#"+deductionType+"_deduction_amount_"+k).attr('readonly',true);
         });
      }
   }
</script>
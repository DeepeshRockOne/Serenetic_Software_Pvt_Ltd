...
<head>
    ...
    <?php 
            if(!empty($_SERVER['REQUEST_URI']) && (strpos($_SERVER['REQUEST_URI'],'admin/') == false) && (strpos($_SERVER['REQUEST_URI'],'groups/') == false) && (strpos($_SERVER['REQUEST_URI'],'agents/') == false)){
                include_once 'layout/bablic.inc.php';
            }
        ?>
        ...
        <div class="container">
            <div class="clearfix mb25">
                ...
                <div class="pull-right">
                    <a href="<?=$website_enroll_link?>" class="btn btn-action">Get Coverage</a>
                </div>
            </div>
            <div class="row">
...
<div class="smarte_footer" style="padding-top: 0px;">
    <div class="container">
        <div class="footer_help" style="display: none;">
            <div class="pull-left">

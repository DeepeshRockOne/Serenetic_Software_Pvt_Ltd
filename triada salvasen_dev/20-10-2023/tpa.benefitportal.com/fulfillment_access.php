...
$sel_file = "SELECT *,AES_DECRYPT(password,'" . $CREDIT_CARD_ENC_KEY . "') as file_passord FROM fulfillment_requests WHERE md5(id)=:id AND md5(file_id)=:file_id";
$sel_params = array(":id" => $id,":file_id" => $fId);
$res_file = $pdo->selectOne($sel_file,$sel_params);
$ELIGIBILITY_FILES_PATH = $UPLOAD_WEB.'/uploads/fulfillment_files/';
...
$template = 'fulfillment_access.inc.php';

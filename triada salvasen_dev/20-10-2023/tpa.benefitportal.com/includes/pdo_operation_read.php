...
class PdoOptRead {
  ...
  public function __construct() {
    ...
    global $RDBSERVER, $DATABASENAME, $LOG_DB, $STATS_DB, $WEBIM_DB, $RUSERNAME, $RPASSWORD;
    $CHAR_SET='utf8';
    $DB_PORT=3306;
    try {
      $this->dbh = new PDO("mysql:host={$RDBSERVER};port={$DB_PORT};dbname={$DATABASENAME};charset={$CHAR_SET}", $RUSERNAME, $RPASSWORD);
...
$tmp_arr['USER'] = $RUSERNAME;
$tmp_arr['NAME'] = $RDBSERVER;

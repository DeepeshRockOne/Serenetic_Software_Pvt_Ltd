...
class timthumb {
	...
	public function __construct() {
		...
		if ($this->param('encode') != "") {
			$this->src = base64_decode($this->param('path')) . "/" . $this->param("src");
		}

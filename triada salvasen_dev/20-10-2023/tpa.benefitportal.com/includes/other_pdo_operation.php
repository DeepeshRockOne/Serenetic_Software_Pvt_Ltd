...
class OtherPdoOpt {
  ...
  public function __construct() {
    ...
    global $OTHER_DBSERVER, $OTHER_DATABASENAME, $OTHER_LOG_DB, $OTHER_STATS_DB, $OTHER_WEBIM_DB, $OTHER_USERNAME, $OTHER_PASSWORD;

    $CHAR_SET='utf8';
    $DB_PORT=3306;
    try {
      $this->dbh = new PDO("mysql:host={$OTHER_DBSERVER};port={$DB_PORT};dbname={$OTHER_DATABASENAME};charset={$CHAR_SET}", $OTHER_USERNAME, $OTHER_PASSWORD);
      ...
      $tmp_arr['USER'] = $OTHER_USERNAME;
      $tmp_arr['NAME'] = $OTHER_DBSERVER;
      $tmp_arr['DNAME'] = $OTHER_DATABASENAME;

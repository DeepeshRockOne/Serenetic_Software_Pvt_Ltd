...
if(!empty($agentIds) && !$multipleAgentExport){
    ...
    //************* Activity Code Start *************
        ...
        activity_feed(3, $_SESSION['agents']['id'], 'Agent',$agentRes['agentId'], 'Agent',"Exported Commissions", $_SESSION['agents']['fname'],$_SESSION['agents']['lname'],json_encode($description));
    //************* Activity Code End *************
}else{
	   //************* Activity Code Start *************
        $description['ac_message'] =array(
        ...
        activity_feed(3, $_SESSION['agents']['id'], 'Agent',0, 'Agent',"Exported Commissions", $_SESSION['agents']['fname'],$_SESSION['agents']['lname'],json_encode($description));
    //************* Activity Code End *************
}
...
if (!empty($pay_period)) {
	...
	$job_id = add_export_request_api('EXCEL',$_SESSION['agents']['id'],'Agent',"Commission Report","commission_export",$incr,$sch_params,$extraParams);

...
if ($validate->isValid()) {
    ...
    activity_feed(3,$_SESSION['agents']['id'], 'Agent' , $_SESSION['agents']['id'], 'Agent','Agent Sent Communication to Group',"","",$desc);
    ...
    if(!empty($trigger_row)) {
        ...
        activity_feed(3,$cust_row['id'],'Group',$cust_row['id'],'Group','Agent Sent Communication to Group',$cust_row['fname'],"",$desc);
    }
    $response['msg'] = $msg;
    echo json_encode($response);
    dbConnectionClose();

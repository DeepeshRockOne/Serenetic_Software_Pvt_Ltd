	...
	if ($validate->isValid()) {
		...
		if(in_array($data_action,array("update","draft"))) {
			...
			if(empty($af_row)) {
	            ...
	            activity_feed(3, $_SESSION['agents']['id'], 'Agent', $pb_row['id'], 'page_builder', 'Website Created', $_SESSION['agents']['fname'], $_SESSION['agents']['lname'], $desc);
			} else {
	            ...
	            $desc = json_encode($desc);
	            $response['desc'] = $desc;
	            activity_feed(3, $_SESSION['agents']['id'], 'Agent', $pb_row['id'], 'page_builder', 'Website Updated', $_SESSION['agents']['fname'], $_SESSION['agents']['lname'], $desc);
			}
		}
	}
} else {

...
$description['ac_message'] = array(
    ...
    'ac_message_1' =>'  viewed Transaction ',
    'ac_red_2'=>array(
...
activity_feed(3, $_SESSION['agents']['id'], 'Agent', $_SESSION['agents']['id'], 'Agent', 'Agent Viewed Transaction.', $_SESSION['agents']['fname'], $_SESSION['agents']['lname'], $desc);

...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" src="<?=$HOST?>/thirdparty/clipboard/clipboard.min.js"></script>
    ...
    <?php if (isset($exJs)): ?>
        ...
        <?php endforeach;?>
    <?php endif;?>
    <script type="text/javascript" src="<?=$AGENT_HOST?>/js/bootstrap-datetimepicker.js"></script>
  ...
  <?php $theme_color = $pdo->selectOne("SELECT theme_color from customer_settings where id = :id",array(":id" => $_SESSION['agents']['id']));?>

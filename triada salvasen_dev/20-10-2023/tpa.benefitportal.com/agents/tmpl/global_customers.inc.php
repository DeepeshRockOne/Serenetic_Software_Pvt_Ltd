      ...
      foreach ($fetch_rows as $rows) {?>
        <tr>
              ...
              <td class="icons">
                ...
                <a href="member_enrollment.php?customer_id=<?php echo $rows['id']; ?>" target="_blank" data-toggle="tooltip" data-placement="top" title="Add Products"><i class="fa fa-plus"></i></a>
              </td>
            </tr>
      <?php } ?>
    <tfoot>

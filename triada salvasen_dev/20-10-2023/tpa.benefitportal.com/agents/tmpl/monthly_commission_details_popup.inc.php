            ...
            <table class="m-b-30 weekly_com_sum">
               <tbody>
                  ...
                  <tr>
                    ...
                    <td><strong>Total Commissions:</strong>&nbsp; <?=dispCommAmt($resMonthlyCommission['commTotal'])?></td>
                  </tr>
                </tbody>
            </table>
         </div>
   ...
   <div class="theme-form">
      ...
      <div class="row">
        ...
        <div class="form-group height_auto">
            ...
            <a href="monthly_commission_details_popup.php?pay_period=<?=$pay_period?>" class="btn btn-info btn-outline" onclick="$('#ajax_loader').show()">Clear Search</a>
       </div>
      </form>
   </div>
            ...
            <tbody>
               ...
               <?php
                  ...
                  foreach($display_commission as $ckey => $com_row) {
                     ...
                     $add_class = $ckey == 'Reverse' ? 'text-red' : '';
               ?>
               <tr>

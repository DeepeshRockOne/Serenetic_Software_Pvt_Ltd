              ...
              <tr>
                ...
                <td class="text-center icons">
                    <?php if($value['coll_type']=="pdf"){ ?>
                      <a href="<?=$COLLATERAL_DOCUMENT_WEB . $value['coll_doc_url'] ?>" download><i class="fa fa-download"></i></a>
                    <?php }else if($value['coll_type']=="link"){ ?>
                      <a href="<?=$value['coll_doc_url'] ?>" target="_BLANK"><i class="fa fa-external-link"></i></a>

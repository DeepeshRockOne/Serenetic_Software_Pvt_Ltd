...
<div class="container m-t-30">
          ...
          <div class="phone-control-wrap">
            ...
            <div class="phone-addon theme-form text-left">
              ...
              <div class="row">
                ...
                <div class="filter_div" id="filter_div_expect_products" style="<?=(!empty($broadcaster_res) && in_array($user_type, array('Agents', 'Members')) && $specific_user_group == 'N') ? '' : 'display: none;'?>">
                  <div class="col-md-1">
                  ...
                  <div class="col-md-2">
                    <div class="form-group ">
                      <select name="product_status" class="form-control">
                        <option value=""></option>
                        <option value="Active" <?= (!empty($broadcaster_res) && !empty($product_status) && $product_status == "Active") ? "selected='selected'" : '' ?>>Active</option>
                        <option value="Pending" <?= (!empty($broadcaster_res) && !empty($product_status) && $product_status == "Pending") ? "selected='selected'" : '' ?>>Pending</option>
                        <option value="Terminated" <?= (!empty($broadcaster_res) && !empty($product_status) && $product_status == "Terminated") ? "selected='selected'" : '' ?>>Terminated</option>
                      </select>
                  ...
                  <div class="col-md-2">
                    <div class="form-group ">
                      <select name="lead_status" class="form-control">
                        <option value=""></option>
                        <option value="New" <?= (!empty($broadcaster_res) && !empty($lead_status) && $lead_status == "New") ? "selected='selected'" : '' ?>>New</option>
                        <option value="Working" <?= (!empty($broadcaster_res) && !empty($lead_status) && $lead_status == "Working") ? "selected='selected'" : '' ?>>Working</option>
                        <option value="Open" <?= (!empty($broadcaster_res) && !empty($lead_status) && $lead_status == "Open") ? "selected='selected'" : '' ?>>Open</option>
                        <option value="Unqualified" <?= (!empty($broadcaster_res) && !empty($lead_status) && $lead_status == "Unqualified") ? "selected='selected'" : '' ?>>Unqualified</option>
                        <option value="Abandoned" <?= (!empty($broadcaster_res) && !empty($lead_status) && $lead_status == "Abandoned") ? "selected='selected'" : '' ?>>Abandoned</option>
                        <option value="Converted" <?= (!empty($broadcaster_res) && !empty($lead_status) && $lead_status == "Converted") ? "selected='selected'" : '' ?>>Converted</option>
                      </select>
                        ...
                        <select name="specific_leads[]" class="se_multiple_select" multiple="multiple">
                          <?php  if(!empty($lead_res)) { ?>
                            <?php foreach ($lead_res as $key => $value) { ?>
                              <option value="<?= $value['id'] ?>" <?= (!empty($broadcaster_res) && !empty($specific_user_ids_array) && in_array($value['id'], $specific_user_ids_array)) ? "selected='selected'" : '' ?>><?= $value['lead_name'] . ' - (' . $value['lead_id'] . ') ' ?></option>
                            <?php } ?>
                          <?php } ?>
                        </select>
                        ...
                        <select name="specific_member[]" class="se_multiple_select" multiple="multiple">
                          <?php  if(!empty($member_res)) { ?>
                            <?php foreach ($member_res as $key => $value) { ?>
                              <option value="<?= $value['id'] ?>" <?= (!empty($broadcaster_res) && !empty($specific_user_ids_array) && in_array($value['id'], $specific_user_ids_array)) ? "selected='selected'" : '' ?>><?= $value['name'] . ' - (' . $value['rep_id'] . ') ' ?></option>
                            <?php } ?>
                          <?php } ?>
                        </select>
                        <label>Select Specific Member(s)</label>
        ...
        <div class="theme-form">
          ...
          <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-3">
              <div class="form-group ">
                <input type="text" class="form-control no_space" name="broadcast_from_address" value="<?=$broadcast_from_address; ?>">
              ...
              <div class="form-group ">
                <select name="email_template" class="form-control" id="email_template">
                  <option value="<?=$templatedata['id']?>" selected="selected"><?=$templatedata['title']?></option>
                </select>
            ...
            <div class="col-lg-9 col-md-9 col-sm-9">
              ...
              <div class="clearfix m-t-25 pull-right">
            ...
            <!-- <div class="col-lg-3 col-md-3 col-sm-3">
              <div class="editor_tag_wrap">
                ...
                <div class="editor_tag_wrap_inner" style="max-height:335px;"> </div>
              </div>
            </div> -->
          </div>
          <hr>
  ...
  <div  id="attachements_dynamic_div" style="display: none">
      <div class="m-t-15" id="attachment_file_div_~file_id~">
          <div class="phone-control-wrap">
              <div class="phone-addon">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $(document).on("click", ".delete_attachment", function(e) {
        ...
        swal({
            ...
            $("#ajax_loader").show();
            $.ajax({
                url: '<?= $AGENT_HOST ?>/ajax_delete_email_attachment.php',
                dataType: 'JSON',
                type: 'POST',
                data: {id: id},
  ...
  $(document).on("change", "#user_group", function(){
    if($(this).val() != '' && $(this).val() != undefined){
      ...
      if($(this).val() == 'Leads'){
        $("#filter_div_expect_products").hide();
        $("#filter_div_leads").show();
      } else {
        $("#filter_div_expect_products").show();
  ...
  $('#broadcast_form').ajaxForm({
      ...
      url:"<?= $AGENT_HOST ?>/ajax_add_email_broadcast.php",
      method: 'POST',
      dataType: 'json',
      success: function(res) {
        $("#ajax_loader").hide();
        if (res.status == 'success') {
          ...
          } else if(res.action_type == 'draft'){
            setNotifySuccess("Broadcaster Saved");
            setTimeout(function(){ 
              window.location.href = 'communications_queue.php';
            }, 1000);
          }else if(res.action_type == 'send'){
            setNotifySuccess("Broadcaster Scheduled");
            setTimeout(function(){ 
              window.location.href = 'communications_queue.php';
            }, 1000);
          }

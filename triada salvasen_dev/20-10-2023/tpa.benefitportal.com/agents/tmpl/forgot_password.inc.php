<div class="panel panel-default">
  <div class="panel-body login-alert-modal">
    <div class="media br-n pn mn">
      <div class="media-left"> <img src="<?php echo $AGENT_HOST; ?>/images/<?= $DEFAULT_LOGO_IMAGE ?>" align="left"> </div>
      <div class="media-body theme-form">
        <h3 class="text-blue m-t-n fw600" >Forgot Password?</h3>
        <p>Enter the Agent ID below to reset your password</p>
        <div class="clearfix"></div>
        <form method="post" autocomplete="off" >
          <div class="form-group height_auto">
            <input name="rep_id" id="rep_id" autocomplete="off" class="form-control" type="text" value="<?=isset($rep_id) ? $rep_id : '';?>" required="" />
            <label>Agent ID</label>
            <?php if (isset($errors['rep_id'])) { ?>
              <p class="error"><?php echo $errors['rep_id']; ?></p>
            <?php } ?>
          </div>

...
<div class="panel panel-default panel-block  ">
            ...
            <table class="m-b-30 weekly_com_sum">
               <tbody>
                  ...
                  <tr>
                     ...
                     <td><strong>Total Commissions:</strong>&nbsp; <?=dispCommAmt($resWeeklyCommission['commTotal'])?></td>
                  </tr>
               </tbody>
            </table>
         </div>
   ...
   <form id="reps_search_form" method="GET">
      ...
      <div class="form-group height_auto">
         ...
         <a href="weekly_commission_details_popup.php?pay_period=<?=$pay_period?>&agent_id=<?=$agent_id?>" class="btn btn-info btn-outline" onclick="$('#ajax_loader').show()">Clear Search</a>
      </div>
   </form>
   </div>
      <div class="table-responsive com_panel_tabel">
         <table class="table" style="table-layout: fixed;">
            <tbody>
            <?php 
               $totaladjustCommission=$totalCommission = 0;

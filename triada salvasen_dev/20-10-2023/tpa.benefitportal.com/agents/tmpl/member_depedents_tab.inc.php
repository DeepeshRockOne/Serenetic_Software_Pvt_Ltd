         ...
         <?php if(!empty($member_dependents) && count($member_dependents) > 0) {
            ...
            <tr>
               ...
               <td class="icons">
                  ...
                  <a href="add_depedents.php?id=<?=$customer_id?>&dep_id=<?=$dep['id']?>&action=Edit"  data-toggle="tooltip" data-trigger="hover" data-placement="top" title="Edit" class="edit_depedents"><i class="fa fa-edit" aria-hidden="true"></i></a>
                  <a href="javascript:void(0)" data-dep_id="<?=$dep['id']?>" data-toggle="tooltip" data-trigger="hover" data-placement="top" title="Delete" data-products='<?=$dep['products']?>' data-name="<?=$dep['fname'].' '.$dep['lname'].' ('.$dep['display_id'].')'?>" class="delete_depedents"><i class="fa fa-trash" aria-hidden="true"></i></a>
                  <?php } else { echo "-"; }?>
               </td>
            </tr>

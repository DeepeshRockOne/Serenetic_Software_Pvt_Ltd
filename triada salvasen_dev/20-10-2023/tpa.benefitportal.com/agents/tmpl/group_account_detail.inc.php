<form action="" name="account_detail" id="account_detail" method="POST">
    ...
    <input type="hidden" name="is_address_verified" id="is_address_verified" value="<?=$group_row['is_address_verified']?>">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                     <div class="form-group">
                        ...
                        <input type="hidden" name="old_business_address" value="<?= $business_address ?>">
                     </div>
                </div>
                <div class="col-sm-6">
                     <div class="form-group">
                ...
                <div class="col-sm-2">
                     <div class="form-group">
                        ...
                        <input type="hidden" name="old_zipcode" value="<?= $zipcode ?>">
                     </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
    ...
    <div role="tabpanel" class="tab-pane" id="gp_attributes">
       ...
       <div class="form-group attributes_btn height_auto clearfix">
            ...
            <?php if(!empty($group_row) && $group_row['status'] == 'Active'){ ?>
                <a href="<?=$HOST?>/downloads3bucketfile.php?file_path=<?=urlencode($GROUP_AGREEMENT_CONTRACT_FILE_PATH)?>&file_name=<?=urlencode($group_row['agent_contract_file'])?>&user_id=<?=$group_id?>&location=agent_group_details" class="btn btn-action btn-outline">Group Agreement</a>
            <?php } ?>
       </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('.group_access_edit').colorbox({iframe: true, width: '450px', height: '630px'});
        $('.group_account_managers').colorbox({iframe: true, width: '900px', height: '570px'});
    ...
    load_group_company = function(){
      ...
      $group_id = $("#group_id_").val();
      $.ajax({
         url:'ajax_load_group_company.php',
         dataType:'JSON',
    ...
    $(document).on("click","#add_group_resource",function(){
         $group_id = $("#group_id_").val();
         $.colorbox({
            href:'groups_add_resource.php?group_id='+$group_id,
            iframe: true, 
            width: '768px', 
            height: '320px',
            onClosed:function(){
    ...
    $(document).on("click",".edit_group_resource",function(){
         ...
         $group_id = $("#group_id_").val();
         $.colorbox({
            href:'groups_add_resource.php?id='+$id+'&group_id='+$group_id,
            iframe: true, 
            width: '768px', 
            height: '320px',
            onClosed:function(){
    ...
    $(document).on("click",".delete_group_resource",function(){
         ...
         $("#ajax_loader").show();
         $.ajax({
            url:'ajax_delete_group_resource.php',
            dataType:'JSON',
            data:{id:$id,group_id:$group_id},
            type:'POST',
            success:function(res){
    ...
    load_group_resource = function(){
      ...
      $group_id = $("#group_id_").val();
      $.ajax({
         url:'ajax_load_group_resource.php',
         dataType:'JSON',

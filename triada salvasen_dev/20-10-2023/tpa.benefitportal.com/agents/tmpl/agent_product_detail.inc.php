<div class="panel panel-default">
   ...
   <div class="panel-body">
         <ul class="nav nav-tabs tabs customtab" role="tablist">
            <li role="presentation" class="active"><a href="#Agent_View" data-toggle="tab" aria-expanded="false">Agent Information</a>
         </li>
            <li role="presentation" class=""><a href="#LimitationsTab" data-toggle="tab" aria-expanded="false">Limitations & Exclusions</a></li>
...
<div class="tab-content m-t-20">
   ...
   <div role="tabpanel" class="tab-pane" id="LimitationsTab">
      <h3><?= $product_name ?></h3>
      <div class="portal_prdinfo_scroll">
...
<div class="br-t text-center p-t-10 m-b-15">
...
load_resource = function(search_val){
  ...
  $('#ajax_loader').show();
  $.ajax({
    url:'agent_product_resource.php?product_id='+$product_id,
    type: 'GET',
    data: {
      is_ajaxed: 1,

<?php if ($is_ajaxed) { ?>
    <div class="clearfix">
        <h4 class="m-t-0 pull-left"><?=get_pay_period_range_text($pay_period);?></h4>
...
<?php } else { ?>
<form id="frm_search" action="weekly_commission.php" method="GET" class="sform">
...
<div class="panel panel-default">
    <div class="panel panel-heading">
        <div class="panel-title">
            <h4 class="mn">Weekly Commissions - <span class="text-success"><?=displayAmount($header_commission_res['weekly']);?></span></h4>
        </div>
    </div>

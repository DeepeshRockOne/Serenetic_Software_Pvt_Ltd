...
<div class="container m-t-30">
    <form id="page_builder_file_upload" enctype="multipart/form-data" action="<?= $AGENT_HOST ?>/ajax_page_edit_image.php">
    ...
    <div class="panel-builder">
        ...
        <!-- tabs End -->
        <form id="page_builder" method="POST" class="event_form" enctype="multipart/form-data" action="<?= $AGENT_HOST ?>/ajax_page_edit.php">
                            ...
                            <div id="top_fold_panel" class="tab-pane fade active in">
                                <div class="panel-body pn">
                                    <div class="org_panel_text theme-form">
                                        <div class="m-b-25">
                                            <h4 class="pb-title">Top Heading</h4>
                                        ...
                                        <div class="m-b-25">
                                            <textarea name="header_subcontent" id="header_subcontent"
                                                          ...
                                                          maxlength="<?= SUBHEADER_CONTENT_LIMIT ?>"><?= substr($header_subcontent, 0, SUBHEADER_CONTENT_LIMIT) ?></textarea>
                                    ...
                                    <div class="org_panel_text theme-form">
                                        ...
                                        <div class="form-group ">
                                            <div class="input-group">
                                                ...
                                                <input class="tblur form-control" value="<?= $user_name ?>"
                                        ...
                                        <p>Request a Quote - Phone # for assistance*</p>
                                        <div class="form-group">
                            ...
                            <div class="form-group  mr15">
                                ...
                                <ul class="flip_option mtn">
                                    <li><a href="javascript:void(0);" id="scaleX" title="Flip Horizontal"><img
                                                    src="<?= $AGENT_HOST ?>/images/flip-h.svg" width="25px"/></a></li>
                                    <li><a href="javascript:void(0);" id="scaleY" title="Flip Vertical"><img
                                                    src="<?= $AGENT_HOST ?>/images/flip-v.svg" width="25px"/></a></li>
                                </ul>
                            </div>
                            <div class="form-group  mr15">

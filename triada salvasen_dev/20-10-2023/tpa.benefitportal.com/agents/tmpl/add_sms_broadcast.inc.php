          ...
          <p class="fs20 m-b-20">+ Text Message (SMS) Broadcast</p>
              ...
              <div class="form-group ">
                <select class="form-control" name="user_group" id="userGroupSel">
                  <option></option>
                  <option value="Agents" <?=($userGroup == 'Agents') ? "selected='selected'" : '' ?>>Agents</option>
                  <?php /*<option value="Members" <?=($userGroup == 'Members') ? "selected='selected'" : '' ?>>Members</option>*/?>
                  <option value="Leads" <?=($userGroup == 'Leads') ? "selected='selected'" : '' ?>>Leads</option>
                </select>
          ...
          <div class="col-lg-3 col-md-3 col-sm-4">
            <div class="phone_preview_wrap">
              <div class="phone_preview_thumb">
                <img src="<?=$AGENT_HOST?>/images/iphone.png" class="img-responsive">
              </div>
...
<script type="text/javascript">
  ...
  ajaxCall = function(){
    $("#ajax_loader").show();
    $.ajax({
      url:"<?= $AGENT_HOST ?>/ajax_add_sms_broadcast.php",

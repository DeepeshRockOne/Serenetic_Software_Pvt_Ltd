...
$reversal_access = agent_has_additional_access('reversals_orders');
$SortBy = "";
$SortDirection = "ASC";
...
if ($is_order_ajaxed) {
	...
	try {
        ...
        AES_DECRYPT(obi.ach_account_number,'".$CREDIT_CARD_ENC_KEY."') as order_ach_acc_no, c.rep_id as c_rep_id  from orders o 

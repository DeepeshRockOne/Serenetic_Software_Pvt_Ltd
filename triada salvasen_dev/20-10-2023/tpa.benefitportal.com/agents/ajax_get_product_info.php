...
$benefit_tier_access = agent_has_additional_access('benefit_tier');
$effective_access = agent_has_additional_access('effective_date');
$termination_access = agent_has_additional_access('termination_date');
$policy_access = agent_has_additional_access('policy_change');
...
$save_button_op = true;
if ($has_full_access == false || $ce_row['process_status'] == 'Cancelled' || ($ce_row['process_status'] == 'Pending' && !empty($parent_ce_row) && $parent_ce_row['new_plan_id'] > 0 && $parent_ce_row['process_status'] == "Pending" && $parent_ce_row['id'] == $ce_row['parent_coverage_id']) || ($ce_row['new_plan_id'] > 0 && $ce_row['process_status'] == "Pending" && !empty($new_ws_row))) {
                                        ...
                                        <td>
                                            <div class="theme-form pr">
                                                <?php if($policy_change_op == false) { ?>
                                                    <?= $data['name'] ?>
                                                    <?php if ($has_full_access == true && $policy_change_reason == "policy_change" && $ce_row['new_plan_id'] > 0 && $ce_row['process_status'] == "Pending" && !empty($new_ws_row)) { ?>
                                                        &nbsp;
                                                    ...
                                                    <?php if ($has_full_access == true && $policy_change_reason == "policy_change" && $ce_row['process_status'] == 'Pending' && !empty($parent_ce_row) && $parent_ce_row['new_plan_id'] > 0 && $parent_ce_row['process_status'] == "Pending" && $parent_ce_row['id'] == $ce_row['parent_coverage_id']) { ?>
                                                        &nbsp;
                                                        <a href="javascript:void(0)" data-container="body" style="font-weight: 700"
                                                           data-html="true"
                                                           data-template='<div class="popover popover-danger" ><div class="arrow"></div><div class="popover-inner"><div class="popover-content"></div></div></div>'
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($tier_change_op == false) {
                                                ...
                                                ?>
                                                <?php if ($has_full_access == true && $policy_change_reason == "benefit_tier_change" && $ce_row['new_plan_id'] > 0 && $ce_row['process_status'] == "Pending" && !empty($new_ws_row)) { ?>
                                                    &nbsp;
                                                    <a href="javascript:void(0)" data-container="body" style="font-weight: 700"
                                                       data-html="true"
                                                       data-template='<div class="popover popover-danger" ><div class="arrow"></div><div class="popover-inner"><div class="popover-content"></div></div></div>'
                                                ...
                                                <?php if ($has_full_access == true && $policy_change_reason == "benefit_tier_change" && $ce_row['process_status'] == 'Pending' && !empty($parent_ce_row) && $parent_ce_row['new_plan_id'] > 0 && $parent_ce_row['process_status'] == "Pending" && $parent_ce_row['id'] == $ce_row['parent_coverage_id']) { ?>
                                                    &nbsp;
                                                    <a href="javascript:void(0)" data-container="body" style="font-weight: 700"
                                                       data-html="true"
                                                       data-template='<div class="popover popover-danger" ><div class="arrow"></div><div class="popover-inner"><div class="popover-content"></div></div></div>'
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <?php if (check_is_card_exist($data['p_id'])) { ?>
                                        <tr>
                                            <td>ID Card:</td>
                                            <td class="icons">
                                                <a href="<?= $HOST ?>/id_card_popup.php?ws_id=<?= md5($data['ws_id']) ?>&user_type=Agent&user_id=<?=$_SESSION['agents']['id']?>"
                                        ...
                                        <td class="icons">
                                            ...
                                            <?php if ($policy_change_op == true && $tier_change_op == true) { ?>
                                                <?php if (!in_array($data['plan_status'], array("Inactive", "Cancel")) && !($data['new_plan_id'] > 0 && $data['process_status'] == "Pending") && empty($data['termination_date'])) { ?>
                                                    <a href="<?=$HOST?>/effective_billing_date.php?location=agent&ws_id=<?= md5($data['ws_id']) ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="termination_date_td" style="display:<?= !$data['termination_date'] ? 'none' : '' ?>">
                                                ...
                                                &nbsp; &nbsp;
                                                <?php if($termination_date_op == true && $termination_access == true){ ?>
                                            ...
                                            <?php if($termination_date_op == true && $termination_access == true){ ?>
                                                ...
                                                <a href="<?=$HOST?>/add_term_date.php?location=agent&ws_id=<?= md5($data['ws_id']) ?>"
                                                ...
                                                if ($allow_cancel_termination == true && !in_array($data['product_type'],array('Healthy Step','ServiceFee')) && $data['process_status'] != "Pending" && strtotime($data['termination_date']) > 0 && in_array($data['customer_status'], array('Active','Inactive')) && $allow_to_reinstate) {
                                                    ...
                                                    if (in_array($data['reinstate_option'], array('Available Without Restrictions')) || $is_reinstate_option_within == true) { ?>
                                                        ...
                                                        <a href="<?=$HOST?>/cobra_reinstate_products.php?location=agent&customer_id=<?= $data['c_id'] ?>&ws_id=<?= $data['ws_id'] ?>"
                                                           class="reinstate_products btn btn-action m-l-10">Reinstate</i></a>
                                                        <?php }else{ ?>
                                                            <a href="<?=$HOST?>/reinstate_products.php?location=agent&customer_id=<?= $data['c_id'] ?>&ws_id=<?= $data['ws_id'] ?>"
                                                            class="reinstate_products btn btn-action m-l-10">Reinstate</i></a>
                                                           <?php } ?>
                                                    <?php }
                                                }
                                ...
                                foreach ($dependents as $key => $value) { ?>
                                    <tr class="depedents_tr_<?= $value['id'] ?>">
                                        ...
                                        <td class="icons">
                                            ...
                                            <a href="<?=$HOST?>/prd_detail_edit_depedents.php?location=agent&id=<?= $value['id'] ?>"
                                    ...
                                    <div class="row table-footer-row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="pull-right">
                                                <a href="<?=$HOST?>/assign_depedents.php?location=agent&ws_id=<?= md5($data['ws_id']) ?>"
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td class="icons">
                                                ...
                                                <a href="<?=$HOST?>/active_member_since.php?location=agent&ws_id=<?= md5($data['ws_id']) ?>"
                                                   data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Edit"
                                                   class="billing_date_popup m-l-10"><i class="fa fa-edit fa-lg"
                                                                                        aria-hidden="true"></i></a>
                                                <?php } ?>
                                                    ...
                                                    <div class="phone-addon">
                                                        <div class="custom_drag_control ">
                                                            ...
                                                            <input type="file" class="gui-file" id=""
                                                                   name="proof_of_coverage">
                                                            <input type="text" class="gui-input"
                                                                   placeholder="Drag or Select File">
                                                        </div>
                                                    </div>
                                                    <?php } else { ?>
                                                    <div class="phone-addon">
                                                        <div class="custom_drag_control ">
                                                            <span class="btn btn-action">Choose File</span>
                                                            <input type="file" class="gui-file" id=""
                                                                   name="proof_of_coverage" disabled="">
                                                            <input type="text" class="gui-input"
                                                                   placeholder="Drag or Select File" disabled="">
                                                        </div>
                                                    </div>
                                                    <?php } ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($curr_policy_benefit_amount > 0) { ?>
                                                <td>
                                                    ...
                                                    <a href="<?=$HOST?>/benefit_tier_change.php?location=agent&action=benefit_amount_change&ws_id=<?=$data['ws_id']?>"
                                                       data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Edit"
                                                       class="m-l-10 edit_benifit_amount"><i class="fa fa-edit fa-lg"
                                                                                             aria-hidden="true"></i></a>
                                                    <?php } else { ?>
                                                        <?php if ($has_full_access == true && $policy_change_reason == "benefit_amount_change" && $ce_row['new_plan_id'] > 0 && $ce_row['process_status'] == "Pending" && !empty($new_ws_row)) { ?>
                                                            &nbsp;
                                                            <a href="javascript:void(0)" data-container="body" style="font-weight: 700"
                                                               data-html="true"
                                                               data-template='<div class="popover popover-danger" ><div class="arrow" ></div><div class="popover-inner"><div class="popover-content"></div></div></div>'
                                                        ...
                                                        <?php if ($has_full_access == true && $policy_change_reason == "benefit_amount_change" && $ce_row['process_status'] == 'Pending' && !empty($parent_ce_row) && $parent_ce_row['new_plan_id'] > 0 && $parent_ce_row['process_status'] == "Pending" && $parent_ce_row['id'] == $ce_row['parent_coverage_id']) { ?>
                                                            &nbsp;
                                                            <a href="javascript:void(0)" data-container="body" style="font-weight: 700"
                                                               data-html="true"
                                                               data-template='<div class="popover popover-danger"><div class="arrow"></div><div class="popover-inner"><div class="popover-content"></div></div></div>'
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="icons">
                                        ...
                                        <a href="<?=$HOST?>/edit_next_billing_date.php?location=agent&ws_id=<?= md5($data['ws_id']) ?>"
                                           data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Edit"
                                           class="billing_date_popup m-l-10"><i class="fa fa-edit fa-lg"
                                                                                aria-hidden="true"></i></a>
                                        <?php } ?>

...
$sel_file = "SELECT *,AES_DECRYPT(password,'" . $CREDIT_CARD_ENC_KEY . "') as file_passord FROM billing_requests WHERE md5(id)=:id AND md5(file_id)=:file_id";
$sel_params = array(":id" => $id,":file_id" => $fId);
$res_file = $pdo->selectOne($sel_file,$sel_params);
$BILLING_FILES_PATH = $UPLOAD_WEB.'/uploads/billing_files/';
...
$template = 'billing_access.inc.php';

 ...
 */
        (function() {
          var r = function(c, j) {
            ...
            //c.popup( c.config.filebrowserImageBrowseLinkUrl, 500, 500, c.config.filebrowserWindowFeatures || c.config.fileBrowserWindowFeatures );
          ...
          CKEDITOR.dialog.add("image", function(c) {
            //console.log(c);
            //window.open(c.config.filebrowserImageBrowseUrl);

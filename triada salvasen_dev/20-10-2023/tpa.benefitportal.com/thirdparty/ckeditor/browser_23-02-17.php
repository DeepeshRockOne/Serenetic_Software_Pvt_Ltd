<?php include (dirname(__DIR__)).'/../admin/includes/connect.php';
...
if (isset($_POST['s_submit'])) {
  ...
  if ($image['name']) {
    ...
    $destination = $_SERVER['DOCUMENT_ROOT'] . '/myhealthpass/uploads/ckeditor/' . $filename;
...
<html>  
  ...
  <body>  
    <div class="brwrap">
      ...
      <h1>Select Image</h1>
      <?php
        $HOST = "http://" . $_SERVER['HTTP_HOST'].'/carlos';

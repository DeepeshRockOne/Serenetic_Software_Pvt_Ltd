  ...
  function () {
    ...
    _createClass(MultipleSelect, [{
      ...
      value: function initContainer() {
        ...
        this.$choice = $("\n      <button type=\"button\" class=\"ms-choice\"".concat(tabIndex, ">\n      <ul class=\"placeholder\">").concat(this.options.placeholder, "</ul>\n      ").concat(this.options.showClear ? '<div class="icon-close"></div>' : '', "\n      <div class=\"icon-caret\"></div>\n      </button>\n    ")); // default position is bottom
      ...
      value: function events() {
        ...
        var toggleOpen = function toggleOpen(e) {
          ...
          if ($(e.target).hasClass('multiple_selection_choice_remove')) {
            return;
          }
      ...
      value: function update(ignoreTrigger) {
        ...
        if(valueSelects.length > 0){
          $.each(textSelects,function($k,$v){
            var liHTML='<li class="multiple_selection_choice"><span class="multiple_selection_choice_remove" data-title="'+valueSelects[$k]+'">X</span>'+$v+'</li>';
            textSelects1.push(liHTML);
          });
          textSelects = textSelects1;
        }*/
        
        var $span = this.$choice.find('>ul');
        ...
        if (html) {
          $span.removeClass('placeholder').addClass('multiple_selection_rendered').html(html);
        }
        ...
        var _thisCustomRemove=this;
        this.$customRemove=$span.find(".multiple_selection_choice_remove");
        this.$customRemove.off('click').on('click', function (e) {
          e.preventDefault();
          _thisCustomRemove.uncheck($(this).attr('data-title'));
        });
            ...
            if (row.type === 'optgroup') {
              ...
              if (type === 'value' || this.options.single) {
                values.push.apply(values, _toConsumableArray(selectedChildren.map(function (child) {
                  ...
                  //return '<li class="multiple_selection_choice"><span class="multiple_selection_choice_remove" data-title="'+row.value+'">X</span>'+row.text+'</li>'
                  ;
                })));
              } else {
                var dataThis = '';
                ...
                selectedChildren.map(function (child) {
                  values.push('<li class="multiple_selection_choice">'+child[type]+'<span class="multiple_selection_choice_remove" data-title="'+child.value+'"><i class="fa fa-times-circle" aria-hidden="true"></i></span></li>');
                  //values.push(child[type]);
                });
              ...
              if (type === 'value') {
                ...
                values.push('<li class="multiple_selection_choice">'+row.text+'<span class="multiple_selection_choice_remove" data-title="'+row.value+'"><i class="fa fa-times-circle" aria-hidden="true"></i></span></li>');
              }
      ...
      value: function uncheck(value) {
        ...
        this.options.onTagRemove(removeUndefined({
          text: option.text,
          value: option.value,
          selected: option.selected,
          data: option._data

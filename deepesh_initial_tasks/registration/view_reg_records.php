                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo "sotre_register.php?edit_id=".$d->id; ?>" class="btn btn-primary">Edit</a>
                                        <a href="<?php echo "sotre_register.php?delete_id=".$d->id; ?>" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                        <?php
                                }
